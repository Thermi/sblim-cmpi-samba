...
namespace genProvider {
  ...
  CmpiLinux_SambaGlobalForServiceProvider::
   ...
   const CmpiBroker &mbp, const CmpiContext& ctx):
    ...
    CmpiMethodMI(mbp,ctx), CmpiAssociationMI(mbp,ctx), cppBroker(mbp) {
      ...
      interfaceP=Linux_SambaGlobalForServiceFactory::getImplementation();           
      cout<<"Provider was constructed"<<endl;
  };
    
        
  const char * CmpiLinux_SambaGlobalForServiceProvider::
  ...
  int CmpiLinux_SambaGlobalForServiceProvider::isUnloadable() const{
    return 0;
  }
  ...
  void CmpiLinux_SambaGlobalForServiceProvider::completeInstance(
   const Linux_SambaGlobalForServiceInstanceName& instanceName,
   CmpiInstance& target, const CmpiContext& ctx){
	  	
    Linux_SambaGlobalForServiceInstanceName shadowInstanceName(instanceName);
  ...
  void CmpiLinux_SambaGlobalForServiceProvider::copyShadowData (
  ...
  CmpiInstance* CmpiLinux_SambaGlobalForServiceProvider::
  ...
  void CmpiLinux_SambaGlobalForServiceProvider::removeDanglingShadowInstances (
  ...
  CMMethodMIFactory(
   CmpiLinux_SambaGlobalForServiceProvider, CmpiLinux_SambaGlobalForServiceProvider);
    ...
    CMAssociationMIFactory( CmpiLinux_SambaGlobalForServiceProvider,
     CmpiLinux_SambaGlobalForServiceProvider);
  ...
  CmpiStatus CmpiLinux_SambaGlobalForServiceProvider::enumInstanceNames (
  ...
  CmpiStatus CmpiLinux_SambaGlobalForServiceProvider::enumInstances (
   const CmpiContext& ctx, CmpiResult& rslt,
  ...
  CmpiStatus CmpiLinux_SambaGlobalForServiceProvider::getInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, const char* *properties){
     	
    //covert to instanceName
    Linux_SambaGlobalForServiceInstanceName instanceName(cop);
  ...
  CmpiStatus CmpiLinux_SambaGlobalForServiceProvider::createInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
...
//      Linux_SambaGlobalForServiceRepositoryInstance(inst,shadowNameSpaceP)
//      .getCmpiInstance(0);     
...
//       delete(backupShadowInstance);
  ...
  CmpiStatus CmpiLinux_SambaGlobalForServiceProvider::setInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, const CmpiInstance& inst,
  ...
  CmpiStatus CmpiLinux_SambaGlobalForServiceProvider::deleteInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop){
      
    Linux_SambaGlobalForServiceInstanceName instanceName=
     Linux_SambaGlobalForServiceInstanceName(cop);
  ...
  CmpiStatus CmpiLinux_SambaGlobalForServiceProvider::invokeMethod (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& ref, const char* methodName,
   const CmpiArgs& in, CmpiArgs& out){
     	
    Linux_SambaGlobalForServiceInstanceName instanceName=
     Linux_SambaGlobalForServiceInstanceName(ref);
  ...
  CmpiStatus CmpiLinux_SambaGlobalForServiceProvider::associationLogic( 
   ...
   const char** properties) {
    ...
    if( references == 0 && instances == 1 ) {
      ...
      if(cop.classPathIsA("Linux_SambaGlobalOptions")) {
        ...
        Linux_SambaGlobalOptionsInstanceName SettingData(cop);
      ...
      while(enumeration.hasNext()) {
        ...
        const Linux_SambaGlobalForServiceManualInstance manualInstance =
         enumeration.getNext();
  ...
  CmpiStatus CmpiLinux_SambaGlobalForServiceProvider::associators (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, 
   ...
   const char** properties) {
    ...
    cout<<"calling associators() of class Linux_SambaGlobalForService"<<endl;
  ...
  CmpiStatus CmpiLinux_SambaGlobalForServiceProvider::associatorNames (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop,
   const char * assocClass, const char * resultClass,
   const char * role, const char * resultRole) {
   
    cout<<"calling associatorNames() of class Linux_SambaGlobalForService"<<endl;
  ...
  CmpiStatus CmpiLinux_SambaGlobalForServiceProvider::references ( 
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop,
   const char * assocClass, const char * role,
   const char** properties) {
    
    cout<<"calling references() of class Linux_SambaGlobalForService"<<endl;
  ...
  CmpiStatus CmpiLinux_SambaGlobalForServiceProvider::referenceNames (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop,
   const char * assocClass, const char * role) {
   
    cout<<"calling referenceNames() of class Linux_SambaGlobalForService"<<endl;
