...
namespace genProvider {
  ...
  CmpiLinux_SambaShareSecurityForShareProvider::
   ...
   const CmpiBroker &mbp, const CmpiContext& ctx):
    ...
    CmpiMethodMI(mbp,ctx), CmpiAssociationMI(mbp,ctx), cppBroker(mbp) {
      ...
      interfaceP=Linux_SambaShareSecurityForShareFactory::getImplementation();           
      cout<<"Provider was constructed"<<endl;
  };
    
        
  const char * CmpiLinux_SambaShareSecurityForShareProvider::
  ...
  int CmpiLinux_SambaShareSecurityForShareProvider::isUnloadable() const{
    return 0;
  }
  ...
  void CmpiLinux_SambaShareSecurityForShareProvider::completeInstance(
   const Linux_SambaShareSecurityForShareInstanceName& instanceName,
   CmpiInstance& target, const CmpiContext& ctx){
	  	
    Linux_SambaShareSecurityForShareInstanceName shadowInstanceName(instanceName);
  ...
  void CmpiLinux_SambaShareSecurityForShareProvider::copyShadowData (
  ...
  CmpiInstance* CmpiLinux_SambaShareSecurityForShareProvider::
  ...
  void CmpiLinux_SambaShareSecurityForShareProvider::removeDanglingShadowInstances (
  ...
  CMMethodMIFactory(
   CmpiLinux_SambaShareSecurityForShareProvider, CmpiLinux_SambaShareSecurityForShareProvider);
    ...
    CMAssociationMIFactory( CmpiLinux_SambaShareSecurityForShareProvider,
     CmpiLinux_SambaShareSecurityForShareProvider);
  ...
  CmpiStatus CmpiLinux_SambaShareSecurityForShareProvider::enumInstanceNames (
  ...
  CmpiStatus CmpiLinux_SambaShareSecurityForShareProvider::enumInstances (
   const CmpiContext& ctx, CmpiResult& rslt,
  ...
  CmpiStatus CmpiLinux_SambaShareSecurityForShareProvider::getInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, const char* *properties){
     	
    //covert to instanceName
    Linux_SambaShareSecurityForShareInstanceName instanceName(cop);
  ...
  CmpiStatus CmpiLinux_SambaShareSecurityForShareProvider::createInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop,const CmpiInstance& inst){
    ...
    CmpiInstance* backupShadowInstance=0;
     ...
     Linux_SambaShareSecurityForShareRepositoryInstance(inst,shadowNameSpaceP)
     .getCmpiInstance(0);     
  ...
  CmpiStatus CmpiLinux_SambaShareSecurityForShareProvider::setInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, const CmpiInstance& inst,
  ...
  CmpiStatus CmpiLinux_SambaShareSecurityForShareProvider::deleteInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop){
      
    Linux_SambaShareSecurityForShareInstanceName instanceName=
     Linux_SambaShareSecurityForShareInstanceName(cop);
  ...
  CmpiStatus CmpiLinux_SambaShareSecurityForShareProvider::invokeMethod (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& ref, const char* methodName,
   const CmpiArgs& in, CmpiArgs& out){
     	
    Linux_SambaShareSecurityForShareInstanceName instanceName=
     Linux_SambaShareSecurityForShareInstanceName(ref);
  ...
  CmpiStatus CmpiLinux_SambaShareSecurityForShareProvider::associationLogic( 
   ...
   const char** properties) {
    ...
    if( references == 0 && instances == 1 ) {
      ...
      while(enumeration.hasNext()) {
        ...
        const Linux_SambaShareSecurityForShareManualInstance manualInstance =
         enumeration.getNext();
  ...
  CmpiStatus CmpiLinux_SambaShareSecurityForShareProvider::associators (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, 
   ...
   const char** properties) {
    ...
    cout<<"calling associators() of class Linux_SambaShareSecurityForShare"<<endl;
  ...
  CmpiStatus CmpiLinux_SambaShareSecurityForShareProvider::associatorNames (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop,
   const char * assocClass, const char * resultClass,
   const char * role, const char * resultRole) {
   
    cout<<"calling associatorNames() of class Linux_SambaShareSecurityForShare"<<endl;
  ...
  CmpiStatus CmpiLinux_SambaShareSecurityForShareProvider::references ( 
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop,
   const char * assocClass, const char * role,
   const char** properties) {
    
    cout<<"calling references() of class Linux_SambaShareSecurityForShare"<<endl;
  ...
  CmpiStatus CmpiLinux_SambaShareSecurityForShareProvider::referenceNames (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop,
   const char * assocClass, const char * role) {
   
    cout<<"calling referenceNames() of class Linux_SambaShareSecurityForShare"<<endl;
