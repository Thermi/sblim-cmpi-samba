...
namespace genProvider {
  ...
  CmpiLinux_SambaForceGroupForPrinterProvider::
   ...
   const CmpiBroker &mbp, const CmpiContext& ctx):
    ...
    CmpiMethodMI(mbp,ctx), CmpiAssociationMI(mbp,ctx), cppBroker(mbp) {
      ...
      interfaceP=Linux_SambaForceGroupForPrinterFactory::getImplementation();           
      cout<<"Provider was constructed"<<endl;
  };
    
        
  const char * CmpiLinux_SambaForceGroupForPrinterProvider::
  ...
  int CmpiLinux_SambaForceGroupForPrinterProvider::isUnloadable() const{
    return 0;
  }
  ...
  void CmpiLinux_SambaForceGroupForPrinterProvider::completeInstance(
   const Linux_SambaForceGroupForPrinterInstanceName& instanceName,
   CmpiInstance& target, const CmpiContext& ctx){
	  	
    Linux_SambaForceGroupForPrinterInstanceName shadowInstanceName(instanceName);
  ...
  void CmpiLinux_SambaForceGroupForPrinterProvider::copyShadowData (
  ...
  CmpiInstance* CmpiLinux_SambaForceGroupForPrinterProvider::
  ...
  void CmpiLinux_SambaForceGroupForPrinterProvider::removeDanglingShadowInstances (
   const Linux_SambaForceGroupForPrinterInstanceNameEnumeration& dinInsNames){
  ...
  CMMethodMIFactory(
   CmpiLinux_SambaForceGroupForPrinterProvider, CmpiLinux_SambaForceGroupForPrinterProvider);
    ...
    CMAssociationMIFactory( CmpiLinux_SambaForceGroupForPrinterProvider,
     CmpiLinux_SambaForceGroupForPrinterProvider);
  ...
  CmpiStatus CmpiLinux_SambaForceGroupForPrinterProvider::enumInstanceNames (
  ...
  CmpiStatus CmpiLinux_SambaForceGroupForPrinterProvider::enumInstances (
   const CmpiContext& ctx, CmpiResult& rslt,
  ...
  CmpiStatus CmpiLinux_SambaForceGroupForPrinterProvider::getInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, const char* *properties){
     	
    //covert to instanceName
    Linux_SambaForceGroupForPrinterInstanceName instanceName(cop);
  ...
  CmpiStatus CmpiLinux_SambaForceGroupForPrinterProvider::createInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
...
//      Linux_SambaForceGroupForPrinterRepositoryInstance(inst,shadowNameSpaceP)
//      .getCmpiInstance(0);     
...
//       delete(backupShadowInstance);
  ...
  CmpiStatus CmpiLinux_SambaForceGroupForPrinterProvider::setInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, const CmpiInstance& inst,
  ...
  CmpiStatus CmpiLinux_SambaForceGroupForPrinterProvider::deleteInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop){
      
    Linux_SambaForceGroupForPrinterInstanceName instanceName=
     Linux_SambaForceGroupForPrinterInstanceName(cop);
  ...
  CmpiStatus CmpiLinux_SambaForceGroupForPrinterProvider::invokeMethod (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& ref, const char* methodName,
   const CmpiArgs& in, CmpiArgs& out){
     	
    Linux_SambaForceGroupForPrinterInstanceName instanceName=
     Linux_SambaForceGroupForPrinterInstanceName(ref);
  ...
  CmpiStatus CmpiLinux_SambaForceGroupForPrinterProvider::associationLogic( 
   ...
   const char** properties) {
    ...
    if( references == 0 && instances == 1 ) {
      ...
      while(enumeration.hasNext()) {
        ...
        const Linux_SambaForceGroupForPrinterManualInstance manualInstance =
         enumeration.getNext();
  ...
  CmpiStatus CmpiLinux_SambaForceGroupForPrinterProvider::associators (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, 
   ...
   const char** properties) {
    ...
    cout<<"calling associators() of class Linux_SambaForceGroupForPrinter"<<endl;
  ...
  CmpiStatus CmpiLinux_SambaForceGroupForPrinterProvider::associatorNames (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop,
   const char * assocClass, const char * resultClass,
   const char * role, const char * resultRole) {
   
    cout<<"calling associatorNames() of class Linux_SambaForceGroupForPrinter"<<endl;
  ...
  CmpiStatus CmpiLinux_SambaForceGroupForPrinterProvider::references ( 
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop,
   const char * assocClass, const char * role,
   const char** properties) {
    
    cout<<"calling references() of class Linux_SambaForceGroupForPrinter"<<endl;
  ...
  CmpiStatus CmpiLinux_SambaForceGroupForPrinterProvider::referenceNames (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop,
   const char * assocClass, const char * role) {
   
    cout<<"calling referenceNames() of class Linux_SambaForceGroupForPrinter"<<endl;
