...
namespace genProvider {
  ...
  CmpiLinux_SambaGlobalFileNameHandlingForGlobalProvider::
   ...
   const CmpiBroker &mbp, const CmpiContext& ctx):
    ...
    CmpiMethodMI(mbp,ctx), CmpiAssociationMI(mbp,ctx), cppBroker(mbp) {
      ...
      interfaceP=Linux_SambaGlobalFileNameHandlingForGlobalFactory::getImplementation();           
      cout<<"Provider was constructed"<<endl;
  };
    
        
  const char * CmpiLinux_SambaGlobalFileNameHandlingForGlobalProvider::
  ...
  int CmpiLinux_SambaGlobalFileNameHandlingForGlobalProvider::isUnloadable() const{
    return 0;
  }
  ...
  void CmpiLinux_SambaGlobalFileNameHandlingForGlobalProvider::completeInstance(
   const Linux_SambaGlobalFileNameHandlingForGlobalInstanceName& instanceName,
   CmpiInstance& target, const CmpiContext& ctx){
	  	
    Linux_SambaGlobalFileNameHandlingForGlobalInstanceName shadowInstanceName(instanceName);
  ...
  void CmpiLinux_SambaGlobalFileNameHandlingForGlobalProvider::copyShadowData (
  ...
  CmpiInstance* CmpiLinux_SambaGlobalFileNameHandlingForGlobalProvider::
  ...
  void CmpiLinux_SambaGlobalFileNameHandlingForGlobalProvider::removeDanglingShadowInstances (
   const Linux_SambaGlobalFileNameHandlingForGlobalInstanceNameEnumeration& dinInsNames){
  ...
  CMMethodMIFactory(
   CmpiLinux_SambaGlobalFileNameHandlingForGlobalProvider, CmpiLinux_SambaGlobalFileNameHandlingForGlobalProvider);
    ...
    CMAssociationMIFactory( CmpiLinux_SambaGlobalFileNameHandlingForGlobalProvider,
     CmpiLinux_SambaGlobalFileNameHandlingForGlobalProvider);
  ...
  CmpiStatus CmpiLinux_SambaGlobalFileNameHandlingForGlobalProvider::enumInstanceNames (
  ...
  CmpiStatus CmpiLinux_SambaGlobalFileNameHandlingForGlobalProvider::enumInstances (
   const CmpiContext& ctx, CmpiResult& rslt,
  ...
  CmpiStatus CmpiLinux_SambaGlobalFileNameHandlingForGlobalProvider::getInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, const char* *properties){
     	
    //covert to instanceName
    Linux_SambaGlobalFileNameHandlingForGlobalInstanceName instanceName(cop);
  ...
  CmpiStatus CmpiLinux_SambaGlobalFileNameHandlingForGlobalProvider::createInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop,const CmpiInstance& inst){
    ...
    CmpiInstance* backupShadowInstance=0;
     ...
     Linux_SambaGlobalFileNameHandlingForGlobalRepositoryInstance(inst,shadowNameSpaceP)
     .getCmpiInstance(0);     
  ...
  CmpiStatus CmpiLinux_SambaGlobalFileNameHandlingForGlobalProvider::setInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, const CmpiInstance& inst,
  ...
  CmpiStatus CmpiLinux_SambaGlobalFileNameHandlingForGlobalProvider::deleteInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop){
      
    Linux_SambaGlobalFileNameHandlingForGlobalInstanceName instanceName=
     Linux_SambaGlobalFileNameHandlingForGlobalInstanceName(cop);
  ...
  CmpiStatus CmpiLinux_SambaGlobalFileNameHandlingForGlobalProvider::invokeMethod (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& ref, const char* methodName,
   const CmpiArgs& in, CmpiArgs& out){
     	
    Linux_SambaGlobalFileNameHandlingForGlobalInstanceName instanceName=
     Linux_SambaGlobalFileNameHandlingForGlobalInstanceName(ref);
  ...
  CmpiStatus CmpiLinux_SambaGlobalFileNameHandlingForGlobalProvider::associationLogic( 
   ...
   const char** properties) {
    ...
    if( references == 0 && instances == 1 ) {
      ...
      else if(cop.classPathIsA("Linux_SambaGlobalFileNameHandlingOptions")) {
        Linux_SambaGlobalOptionsInstanceEnumeration enumeration;
        Linux_SambaGlobalFileNameHandlingOptionsInstanceName SettingData(cop);
      ...
      if(cop.classPathIsA("Linux_SambaGlobalFileNameHandlingOptions")) {
        Linux_SambaGlobalFileNameHandlingOptionsInstanceName SettingData(cop);
      ...
      while(enumeration.hasNext()) {
        ...
        const Linux_SambaGlobalFileNameHandlingForGlobalManualInstance manualInstance =
         enumeration.getNext();
  ...
  CmpiStatus CmpiLinux_SambaGlobalFileNameHandlingForGlobalProvider::associators (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, 
   ...
   const char** properties) {
    ...
    cout<<"calling associators() of class Linux_SambaGlobalFileNameHandlingForGlobal"<<endl;
  ...
  CmpiStatus CmpiLinux_SambaGlobalFileNameHandlingForGlobalProvider::associatorNames (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop,
   const char * assocClass, const char * resultClass,
   const char * role, const char * resultRole) {
   
    cout<<"calling associatorNames() of class Linux_SambaGlobalFileNameHandlingForGlobal"<<endl;
  ...
  CmpiStatus CmpiLinux_SambaGlobalFileNameHandlingForGlobalProvider::references ( 
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop,
   const char * assocClass, const char * role,
   const char** properties) {
    
    cout<<"calling references() of class Linux_SambaGlobalFileNameHandlingForGlobal"<<endl;
  ...
  CmpiStatus CmpiLinux_SambaGlobalFileNameHandlingForGlobalProvider::referenceNames (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop,
   const char * assocClass, const char * role) {
   
    cout<<"calling referenceNames() of class Linux_SambaGlobalFileNameHandlingForGlobal"<<endl;
