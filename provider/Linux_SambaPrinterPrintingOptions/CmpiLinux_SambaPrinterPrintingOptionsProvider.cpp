...
namespace genProvider {
  ...
  CmpiLinux_SambaPrinterPrintingOptionsProvider::
   ...
   const CmpiBroker &mbp, const CmpiContext& ctx):
    ...
    CmpiMethodMI(mbp,ctx), cppBroker(mbp) {
      ...
      interfaceP=Linux_SambaPrinterPrintingOptionsFactory::getImplementation();           
      cout<<"Provider was constructed"<<endl;
  };
    
        
  const char * CmpiLinux_SambaPrinterPrintingOptionsProvider::
  ...
  int CmpiLinux_SambaPrinterPrintingOptionsProvider::isUnloadable() const{
    return 0;
  }
  ...
  void CmpiLinux_SambaPrinterPrintingOptionsProvider::completeInstance(
   const Linux_SambaPrinterPrintingOptionsInstanceName& instanceName,
   CmpiInstance& target, const CmpiContext& ctx){
	  	
    Linux_SambaPrinterPrintingOptionsInstanceName shadowInstanceName(instanceName);
  ...
  void CmpiLinux_SambaPrinterPrintingOptionsProvider::copyShadowData (
  ...
  CmpiInstance* CmpiLinux_SambaPrinterPrintingOptionsProvider::
  ...
  void CmpiLinux_SambaPrinterPrintingOptionsProvider::removeDanglingShadowInstances (
   const Linux_SambaPrinterPrintingOptionsInstanceNameEnumeration& dinInsNames){
  ...
  CmpiStatus CmpiLinux_SambaPrinterPrintingOptionsProvider::enumInstanceNames (
  ...
  CmpiStatus CmpiLinux_SambaPrinterPrintingOptionsProvider::enumInstances (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, const char* *properties){
    ...
    while ( enumeration.hasNext() ){
   	  ...
   	  const Linux_SambaPrinterPrintingOptionsManualInstance& instance=
       enumeration.getNext();
  ...
  CmpiStatus CmpiLinux_SambaPrinterPrintingOptionsProvider::getInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, const char* *properties){
     	
    //covert to instanceName
    Linux_SambaPrinterPrintingOptionsInstanceName instanceName(cop);
  ...
  CmpiStatus CmpiLinux_SambaPrinterPrintingOptionsProvider::createInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
...
//      Linux_SambaPrinterPrintingOptionsRepositoryInstance(inst,shadowNameSpaceP)
//      .getCmpiInstance(0);     
...
//       delete(backupShadowInstance);
  ...
  CmpiStatus CmpiLinux_SambaPrinterPrintingOptionsProvider::setInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, const CmpiInstance& inst,
...
//       delete(backupShadowInstance);
  ...
  CmpiStatus CmpiLinux_SambaPrinterPrintingOptionsProvider::deleteInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop){
      
    Linux_SambaPrinterPrintingOptionsInstanceName instanceName=
     Linux_SambaPrinterPrintingOptionsInstanceName(cop);
  ...
  CmpiStatus CmpiLinux_SambaPrinterPrintingOptionsProvider::invokeMethod (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& ref, const char* methodName,
   const CmpiArgs& in, CmpiArgs& out){
     	
    Linux_SambaPrinterPrintingOptionsInstanceName instanceName=
     Linux_SambaPrinterPrintingOptionsInstanceName(ref);
