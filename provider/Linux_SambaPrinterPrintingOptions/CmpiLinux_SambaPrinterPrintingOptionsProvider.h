...
#include "Linux_SambaPrinterPrintingOptionsFactory.h"
 ...
 namespace genProvider{
  ...
  class CmpiLinux_SambaPrinterPrintingOptionsProvider : public CmpiInstanceMI,
   public CmpiMethodMI{	
	
	private:

	Linux_SambaPrinterPrintingOptionsInterface* interfaceP;
	const static char * shadowNameSpaceP;
	CmpiBroker cppBroker;
	    
    void completeInstance (
     const Linux_SambaPrinterPrintingOptionsInstanceName& intanceNameP,
    ...
    CmpiInstance* getShadowInstance (
     ...
     const Linux_SambaPrinterPrintingOptionsInstanceName& intanceName);
