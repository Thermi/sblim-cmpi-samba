...
namespace genProvider {
  ...
  CmpiLinux_SambaGlobalBrowseForGlobalProvider::
   ...
   const CmpiBroker &mbp, const CmpiContext& ctx):
    ...
    CmpiMethodMI(mbp,ctx), CmpiAssociationMI(mbp,ctx), cppBroker(mbp) {
      ...
      interfaceP=Linux_SambaGlobalBrowseForGlobalFactory::getImplementation();           
      cout<<"Provider was constructed"<<endl;
  };
    
        
  const char * CmpiLinux_SambaGlobalBrowseForGlobalProvider::
  ...
  int CmpiLinux_SambaGlobalBrowseForGlobalProvider::isUnloadable() const{
    return 0;
  }
  ...
  void CmpiLinux_SambaGlobalBrowseForGlobalProvider::completeInstance(
   const Linux_SambaGlobalBrowseForGlobalInstanceName& instanceName,
   CmpiInstance& target, const CmpiContext& ctx){
	  	
    Linux_SambaGlobalBrowseForGlobalInstanceName shadowInstanceName(instanceName);
  ...
  void CmpiLinux_SambaGlobalBrowseForGlobalProvider::copyShadowData (
  ...
  CmpiInstance* CmpiLinux_SambaGlobalBrowseForGlobalProvider::
  ...
  void CmpiLinux_SambaGlobalBrowseForGlobalProvider::removeDanglingShadowInstances (
   const Linux_SambaGlobalBrowseForGlobalInstanceNameEnumeration& dinInsNames){
  ...
  CMMethodMIFactory(
   CmpiLinux_SambaGlobalBrowseForGlobalProvider, CmpiLinux_SambaGlobalBrowseForGlobalProvider);
    ...
    CMAssociationMIFactory( CmpiLinux_SambaGlobalBrowseForGlobalProvider,
     CmpiLinux_SambaGlobalBrowseForGlobalProvider);
  ...
  CmpiStatus CmpiLinux_SambaGlobalBrowseForGlobalProvider::enumInstanceNames (
  ...
  CmpiStatus CmpiLinux_SambaGlobalBrowseForGlobalProvider::enumInstances (
   const CmpiContext& ctx, CmpiResult& rslt,
  ...
  CmpiStatus CmpiLinux_SambaGlobalBrowseForGlobalProvider::getInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, const char* *properties){
     	
    //covert to instanceName
    Linux_SambaGlobalBrowseForGlobalInstanceName instanceName(cop);
  ...
  CmpiStatus CmpiLinux_SambaGlobalBrowseForGlobalProvider::createInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop,const CmpiInstance& inst){
    ...
    CmpiInstance* backupShadowInstance=0;
     ...
     Linux_SambaGlobalBrowseForGlobalRepositoryInstance(inst,shadowNameSpaceP)
     .getCmpiInstance(0);     
  ...
  CmpiStatus CmpiLinux_SambaGlobalBrowseForGlobalProvider::setInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, const CmpiInstance& inst,
  ...
  CmpiStatus CmpiLinux_SambaGlobalBrowseForGlobalProvider::deleteInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop){
      
    Linux_SambaGlobalBrowseForGlobalInstanceName instanceName=
     Linux_SambaGlobalBrowseForGlobalInstanceName(cop);
  ...
  CmpiStatus CmpiLinux_SambaGlobalBrowseForGlobalProvider::invokeMethod (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& ref, const char* methodName,
   const CmpiArgs& in, CmpiArgs& out){
     	
    Linux_SambaGlobalBrowseForGlobalInstanceName instanceName=
     Linux_SambaGlobalBrowseForGlobalInstanceName(ref);
  ...
  CmpiStatus CmpiLinux_SambaGlobalBrowseForGlobalProvider::associationLogic( 
   ...
   const char** properties) {
    ...
    if( references == 0 && instances == 1 ) {
      ...
      if(cop.classPathIsA("Linux_SambaGlobalBrowseOptions")) {
        Linux_SambaGlobalOptionsInstanceEnumeration enumeration;
        Linux_SambaGlobalBrowseOptionsInstanceName SettingData(cop);
      ...
      while(enumeration.hasNext()) {
        ...
        const Linux_SambaGlobalBrowseForGlobalManualInstance manualInstance =
         enumeration.getNext();
  ...
  CmpiStatus CmpiLinux_SambaGlobalBrowseForGlobalProvider::associators (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, 
   ...
   const char** properties) {
    ...
    cout<<"calling associators() of class Linux_SambaGlobalBrowseForGlobal"<<endl;
  ...
  CmpiStatus CmpiLinux_SambaGlobalBrowseForGlobalProvider::associatorNames (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop,
   const char * assocClass, const char * resultClass,
   const char * role, const char * resultRole) {
   
    cout<<"calling associatorNames() of class Linux_SambaGlobalBrowseForGlobal"<<endl;
  ...
  CmpiStatus CmpiLinux_SambaGlobalBrowseForGlobalProvider::references ( 
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop,
   const char * assocClass, const char * role,
   const char** properties) {
    
    cout<<"calling references() of class Linux_SambaGlobalBrowseForGlobal"<<endl;
  ...
  CmpiStatus CmpiLinux_SambaGlobalBrowseForGlobalProvider::referenceNames (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop,
   const char * assocClass, const char * role) {
   
    cout<<"calling referenceNames() of class Linux_SambaGlobalBrowseForGlobal"<<endl;
