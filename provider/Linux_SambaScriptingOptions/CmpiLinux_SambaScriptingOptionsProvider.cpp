...
namespace genProvider {
  ...
  CmpiLinux_SambaScriptingOptionsProvider::
   ...
   const CmpiBroker &mbp, const CmpiContext& ctx):
    ...
    CmpiMethodMI(mbp,ctx), cppBroker(mbp) {
      ...
      interfaceP=Linux_SambaScriptingOptionsFactory::getImplementation();           
      cout<<"Provider was constructed"<<endl;
  };
    
        
  const char * CmpiLinux_SambaScriptingOptionsProvider::
  ...
  int CmpiLinux_SambaScriptingOptionsProvider::isUnloadable() const{
    return 0;
  }
  ...
  void CmpiLinux_SambaScriptingOptionsProvider::completeInstance(
   const Linux_SambaScriptingOptionsInstanceName& instanceName,
   CmpiInstance& target, const CmpiContext& ctx){
	  	
    Linux_SambaScriptingOptionsInstanceName shadowInstanceName(instanceName);
  ...
  void CmpiLinux_SambaScriptingOptionsProvider::copyShadowData (
  ...
  CmpiInstance* CmpiLinux_SambaScriptingOptionsProvider::
  ...
  void CmpiLinux_SambaScriptingOptionsProvider::removeDanglingShadowInstances (
  ...
  CmpiStatus CmpiLinux_SambaScriptingOptionsProvider::enumInstanceNames (
  ...
  CmpiStatus CmpiLinux_SambaScriptingOptionsProvider::enumInstances (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, const char* *properties){
    ...
    while ( enumeration.hasNext() ){
   	  ...
   	  const Linux_SambaScriptingOptionsManualInstance& instance=
       enumeration.getNext();
  ...
  CmpiStatus CmpiLinux_SambaScriptingOptionsProvider::getInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, const char* *properties){
     	
    //covert to instanceName
    Linux_SambaScriptingOptionsInstanceName instanceName(cop);
  ...
  CmpiStatus CmpiLinux_SambaScriptingOptionsProvider::createInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
...
//      Linux_SambaScriptingOptionsRepositoryInstance(inst,shadowNameSpaceP)
//      .getCmpiInstance(0);     
...
//       delete(backupShadowInstance);
  ...
  CmpiStatus CmpiLinux_SambaScriptingOptionsProvider::setInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, const CmpiInstance& inst,
...
//       delete(backupShadowInstance);
  ...
  CmpiStatus CmpiLinux_SambaScriptingOptionsProvider::deleteInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop){
      
    Linux_SambaScriptingOptionsInstanceName instanceName=
     Linux_SambaScriptingOptionsInstanceName(cop);
  ...
  CmpiStatus CmpiLinux_SambaScriptingOptionsProvider::invokeMethod (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& ref, const char* methodName,
   const CmpiArgs& in, CmpiArgs& out){
     	
    Linux_SambaScriptingOptionsInstanceName instanceName=
     Linux_SambaScriptingOptionsInstanceName(ref);
