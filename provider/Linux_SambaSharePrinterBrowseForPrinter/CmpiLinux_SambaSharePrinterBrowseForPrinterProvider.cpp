...
namespace genProvider {
  ...
  CmpiLinux_SambaSharePrinterBrowseForPrinterProvider::
   ...
   const CmpiBroker &mbp, const CmpiContext& ctx):
    ...
    CmpiMethodMI(mbp,ctx), CmpiAssociationMI(mbp,ctx), cppBroker(mbp) {
      ...
      interfaceP=Linux_SambaSharePrinterBrowseForPrinterFactory::getImplementation();           
      cout<<"Provider was constructed"<<endl;
  };
    
        
  const char * CmpiLinux_SambaSharePrinterBrowseForPrinterProvider::
  ...
  int CmpiLinux_SambaSharePrinterBrowseForPrinterProvider::isUnloadable() const{
    return 0;
  }
  ...
  void CmpiLinux_SambaSharePrinterBrowseForPrinterProvider::completeInstance(
   const Linux_SambaSharePrinterBrowseForPrinterInstanceName& instanceName,
   CmpiInstance& target, const CmpiContext& ctx){
	  	
    Linux_SambaSharePrinterBrowseForPrinterInstanceName shadowInstanceName(instanceName);
  ...
  void CmpiLinux_SambaSharePrinterBrowseForPrinterProvider::copyShadowData (
  ...
  CmpiInstance* CmpiLinux_SambaSharePrinterBrowseForPrinterProvider::
  ...
  void CmpiLinux_SambaSharePrinterBrowseForPrinterProvider::removeDanglingShadowInstances (
  ...
  CMMethodMIFactory(
   CmpiLinux_SambaSharePrinterBrowseForPrinterProvider, CmpiLinux_SambaSharePrinterBrowseForPrinterProvider);
    ...
    CMAssociationMIFactory( CmpiLinux_SambaSharePrinterBrowseForPrinterProvider,
     CmpiLinux_SambaSharePrinterBrowseForPrinterProvider);
  ...
  CmpiStatus CmpiLinux_SambaSharePrinterBrowseForPrinterProvider::enumInstanceNames (
  ...
  CmpiStatus CmpiLinux_SambaSharePrinterBrowseForPrinterProvider::enumInstances (
   const CmpiContext& ctx, CmpiResult& rslt,
  ...
  CmpiStatus CmpiLinux_SambaSharePrinterBrowseForPrinterProvider::getInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, const char* *properties){
     	
    //covert to instanceName
    Linux_SambaSharePrinterBrowseForPrinterInstanceName instanceName(cop);
  ...
  CmpiStatus CmpiLinux_SambaSharePrinterBrowseForPrinterProvider::createInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop,const CmpiInstance& inst){
    ...
    CmpiInstance* backupShadowInstance=0;
     ...
     Linux_SambaSharePrinterBrowseForPrinterRepositoryInstance(inst,shadowNameSpaceP)
     .getCmpiInstance(0);     
  ...
  CmpiStatus CmpiLinux_SambaSharePrinterBrowseForPrinterProvider::setInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, const CmpiInstance& inst,
  ...
  CmpiStatus CmpiLinux_SambaSharePrinterBrowseForPrinterProvider::deleteInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop){
      
    Linux_SambaSharePrinterBrowseForPrinterInstanceName instanceName=
     Linux_SambaSharePrinterBrowseForPrinterInstanceName(cop);
  ...
  CmpiStatus CmpiLinux_SambaSharePrinterBrowseForPrinterProvider::invokeMethod (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& ref, const char* methodName,
   const CmpiArgs& in, CmpiArgs& out){
     	
    Linux_SambaSharePrinterBrowseForPrinterInstanceName instanceName=
     Linux_SambaSharePrinterBrowseForPrinterInstanceName(ref);
  ...
  CmpiStatus CmpiLinux_SambaSharePrinterBrowseForPrinterProvider::associationLogic( 
   ...
   const char** properties) {
    ...
    if( references == 0 && instances == 1 ) {
      ...
      else if(cop.classPathIsA("Linux_SambaSharePrinterBrowseOptions")) {
      ...
      while(enumeration.hasNext()) {
        ...
        const Linux_SambaSharePrinterBrowseForPrinterManualInstance manualInstance =
         enumeration.getNext();
  ...
  CmpiStatus CmpiLinux_SambaSharePrinterBrowseForPrinterProvider::associators (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, 
   ...
   const char** properties) {
    ...
    cout<<"calling associators() of class Linux_SambaSharePrinterBrowseForPrinter"<<endl;
  ...
  CmpiStatus CmpiLinux_SambaSharePrinterBrowseForPrinterProvider::associatorNames (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop,
   const char * assocClass, const char * resultClass,
   const char * role, const char * resultRole) {
   
    cout<<"calling associatorNames() of class Linux_SambaSharePrinterBrowseForPrinter"<<endl;
  ...
  CmpiStatus CmpiLinux_SambaSharePrinterBrowseForPrinterProvider::references ( 
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop,
   const char * assocClass, const char * role,
   const char** properties) {
    
    cout<<"calling references() of class Linux_SambaSharePrinterBrowseForPrinter"<<endl;
  ...
  CmpiStatus CmpiLinux_SambaSharePrinterBrowseForPrinterProvider::referenceNames (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop,
   const char * assocClass, const char * role) {
   
    cout<<"calling referenceNames() of class Linux_SambaSharePrinterBrowseForPrinter"<<endl;
