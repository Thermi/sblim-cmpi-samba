// =======================================================================
// CmpiLinux_SambaSharePrinterBrowseForPrinterProvider.cpp
...
//
// 
#include "CmpiLinux_SambaSharePrinterBrowseForPrinterProvider.h"
...
namespace genProvider {
  ...
  //----------------------------------------------------------------------------
  CmpiLinux_SambaSharePrinterBrowseForPrinterProvider::CmpiLinux_SambaSharePrinterBrowseForPrinterProvider(
    ...
    m_interfaceP = Linux_SambaSharePrinterBrowseForPrinterFactory::getImplementation();           
  ...
  //----------------------------------------------------------------------------
  int 
  CmpiLinux_SambaSharePrinterBrowseForPrinterProvider::isUnloadable() const {
    return 0;
  }
	
  //----------------------------------------------------------------------------
  void 
  CmpiLinux_SambaSharePrinterBrowseForPrinterProvider::completeInstance(
    const Linux_SambaSharePrinterBrowseForPrinterInstanceName& anInstanceName,
    CmpiInstance& anInstance, 
    const CmpiContext& aContext) {
	  	
    Linux_SambaSharePrinterBrowseForPrinterInstanceName shadowInstanceName(anInstanceName);
  ...
  //----------------------------------------------------------------------------
  void 
  CmpiLinux_SambaSharePrinterBrowseForPrinterProvider::copyShadowData(
  ...
  //----------------------------------------------------------------------------
  CmpiInstance* 
  CmpiLinux_SambaSharePrinterBrowseForPrinterProvider::getShadowInstance(
  ...
  //----------------------------------------------------------------------------
  void
  CmpiLinux_SambaSharePrinterBrowseForPrinterProvider::removeDanglingShadowInstances (
   const Linux_SambaSharePrinterBrowseForPrinterInstanceNameEnumeration& anInstanceNameEnumerations) {
  ...
  //                          Provider Factory
  //----------------------------------------------------------------------------
  CMProviderBase(CmpiLinux_SambaSharePrinterBrowseForPrinterProvider);

  CMInstanceMIFactory(
    CmpiLinux_SambaSharePrinterBrowseForPrinterProvider, 
    CmpiLinux_SambaSharePrinterBrowseForPrinterProvider);

  CMMethodMIFactory(
    CmpiLinux_SambaSharePrinterBrowseForPrinterProvider, 
    CmpiLinux_SambaSharePrinterBrowseForPrinterProvider);    CMAssociationMIFactory(
      CmpiLinux_SambaSharePrinterBrowseForPrinterProvider,
      CmpiLinux_SambaSharePrinterBrowseForPrinterProvider);
  ...
  //----------------------------------------------------------------------------
  CmpiStatus 
  CmpiLinux_SambaSharePrinterBrowseForPrinterProvider::enumInstanceNames(
    const CmpiContext& aContext, 
    CmpiResult& aResult,
    ...
    Linux_SambaSharePrinterBrowseForPrinterInstanceNameEnumeration enumeration;
    ...
    while (enumeration.hasNext() ){
      const Linux_SambaSharePrinterBrowseForPrinterInstanceName& instanceName = enumeration.getNext();
  ...
  //----------------------------------------------------------------------------
  CmpiStatus 
  CmpiLinux_SambaSharePrinterBrowseForPrinterProvider::enumInstances(
    const CmpiContext& aContext,
    CmpiResult& aResult,
    const CmpiObjectPath& aCop, 
    ...
    while (enumeration.hasNext()) {
   	  const Linux_SambaSharePrinterBrowseForPrinterManualInstance& instance = enumeration.getNext();
  ...
  //----------------------------------------------------------------------------
  CmpiStatus 
  CmpiLinux_SambaSharePrinterBrowseForPrinterProvider::getInstance (
    const CmpiContext& aContext, 
    CmpiResult& aResult,
    const CmpiObjectPath& aCop,
    const char** aPropertiesPP) {
    ...
    Linux_SambaSharePrinterBrowseForPrinterInstanceName instanceName(aCop);
  ...
  //----------------------------------------------------------------------------
  CmpiStatus 
  CmpiLinux_SambaSharePrinterBrowseForPrinterProvider::createInstance (
    const CmpiContext& aContext,
    CmpiResult& aResult,
    const CmpiObjectPath& aCop,
...
//   	  Linux_SambaSharePrinterBrowseForPrinterRepositoryInstance(aCmpiInstance,"IBMShadow/cimv2").getCmpiInstance(0);     
//     
...
//    }
  ...
  //----------------------------------------------------------------------------
  CmpiStatus 
  CmpiLinux_SambaSharePrinterBrowseForPrinterProvider::setInstance (
    const CmpiContext& aContext,
    CmpiResult& aResult,
    const CmpiObjectPath& aCop,
    const CmpiInstance& aCmpiInstance,
...
//    }
  ...
  //----------------------------------------------------------------------------
  CmpiStatus
  CmpiLinux_SambaSharePrinterBrowseForPrinterProvider::deleteInstance(
    const CmpiContext& aContext,
    CmpiResult& aResult,
    const CmpiObjectPath& aCop) {
      
    Linux_SambaSharePrinterBrowseForPrinterInstanceName instanceName = Linux_SambaSharePrinterBrowseForPrinterInstanceName(aCop);
  ...
  //----------------------------------------------------------------------------
  CmpiStatus
  CmpiLinux_SambaSharePrinterBrowseForPrinterProvider::invokeMethod(
    const CmpiContext& aContext,
    CmpiResult& aResult,
    const CmpiObjectPath& aCop,
  ...
  //----------------------------------------------------------------------------
  CmpiStatus 
  CmpiLinux_SambaSharePrinterBrowseForPrinterProvider::associationLogic( 
    const CmpiContext& aContext, 
    CmpiResult& aResult,
    const CmpiObjectPath& aCop,
    ...
    if( aReferenceFlag == 0 && anInstanceFlag == 1 ) {
      ...
      } else if(aCop.classPathIsA("Linux_SambaSharePrinterBrowseOptions")) {
      ...
      while(enumeration.hasNext()) {
        ...
        const Linux_SambaSharePrinterBrowseForPrinterManualInstance manualInstance = enumeration.getNext();
  ...
  //----------------------------------------------------------------------------
  CmpiStatus 
  CmpiLinux_SambaSharePrinterBrowseForPrinterProvider::associators(
    const CmpiContext& aContext, 
    CmpiResult& aResult,
    const CmpiObjectPath& aCop, 
...
#ifdef DEBUG
    std::cout << "calling associators() of class Linux_SambaSharePrinterBrowseForPrinter" << std::endl;
#endif    
  ...
  //----------------------------------------------------------------------------
  CmpiStatus 
  CmpiLinux_SambaSharePrinterBrowseForPrinterProvider::associatorNames(
    const CmpiContext& aContext,
    CmpiResult& aResult,
    const CmpiObjectPath& aCop,
    const char* anAssociationClassnameP,
...
#ifdef DEBUG
    std::cout << "calling associatorNames() of class Linux_SambaSharePrinterBrowseForPrinter" << std::endl;
#endif    
  ...
  //----------------------------------------------------------------------------
  CmpiStatus
  CmpiLinux_SambaSharePrinterBrowseForPrinterProvider::references( 
    const CmpiContext& aContext,
    CmpiResult& aResult,
    const CmpiObjectPath& aCop,
    const char* anAssociationClassnameP,
...
#ifdef DEBUG
    std::cout << "calling aReferenceFlag() of class Linux_SambaSharePrinterBrowseForPrinter" << std::endl;
#endif    
  ...
  //----------------------------------------------------------------------------
  CmpiStatus
  CmpiLinux_SambaSharePrinterBrowseForPrinterProvider::referenceNames(
    const CmpiContext& aContext,
    CmpiResult& aResult,
    const CmpiObjectPath& aCop,
    const char* anAssociationClassnameP,
...
#ifdef DEBUG
    std::cout << "calling referenceNames() of class Linux_SambaSharePrinterBrowseForPrinter" << std::endl;
#endif    
