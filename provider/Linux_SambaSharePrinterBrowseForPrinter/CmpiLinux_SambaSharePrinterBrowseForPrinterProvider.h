/**
 *  CmpiLinux_SambaSharePrinterBrowseForPrinterProvider.h
 * 
...
#ifndef CmpiLinux_SambaSharePrinterBrowseForPrinterProvider_h
#define CmpiLinux_SambaSharePrinterBrowseForPrinterProvider_h

#include "CmpiInstanceMI.h"
#include "CmpiMethodMI.h"
#include "Linux_SambaSharePrinterBrowseForPrinterFactory.h"
#include "CmpiAssociationMI.h"

 namespace genProvider{

  class CmpiLinux_SambaSharePrinterBrowseForPrinterProvider : public CmpiInstanceMI,
   public CmpiMethodMI, public CmpiAssociationMI{	
	
	private:

	Linux_SambaSharePrinterBrowseForPrinterInterface* interfaceP;
	const static char * shadowNameSpaceP;
	CmpiBroker cppBroker;
	    
    void completeInstance (
     const Linux_SambaSharePrinterBrowseForPrinterInstanceName& intanceNameP,
    ...
    CmpiInstance* getShadowInstance (
     ...
     const Linux_SambaSharePrinterBrowseForPrinterInstanceName& intanceName);
	
    void removeDanglingShadowInstances (
     const Linux_SambaSharePrinterBrowseForPrinterInstanceNameEnumeration& dinInsNames);
