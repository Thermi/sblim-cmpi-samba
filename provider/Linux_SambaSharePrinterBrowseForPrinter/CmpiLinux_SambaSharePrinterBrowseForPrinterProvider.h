...
namespace genProvider{
  ...
  class CmpiLinux_SambaSharePrinterBrowseForPrinterProvider : 
    public CmpiInstanceMI,
    public CmpiMethodMI, public CmpiAssociationMI {	
	
	  private:
	  Linux_SambaSharePrinterBrowseForPrinterInterface* m_interfaceP;
	  CmpiBroker m_cmpiBroker;
	    
	  private:

    void completeInstance(
      const Linux_SambaSharePrinterBrowseForPrinterInstanceName& anInstanceNameP,
