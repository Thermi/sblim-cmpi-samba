...
namespace genProvider {
  ...
  CmpiLinux_SambaGuestAccountForGlobalProvider::
   ...
   const CmpiBroker &mbp, const CmpiContext& ctx):
    ...
    CmpiMethodMI(mbp,ctx), CmpiAssociationMI(mbp,ctx), cppBroker(mbp) {
      ...
      interfaceP=Linux_SambaGuestAccountForGlobalFactory::getImplementation();           
      cout<<"Provider was constructed"<<endl;
  };
    
        
  const char * CmpiLinux_SambaGuestAccountForGlobalProvider::
  ...
  int CmpiLinux_SambaGuestAccountForGlobalProvider::isUnloadable() const{
    return 0;
  }
  ...
  void CmpiLinux_SambaGuestAccountForGlobalProvider::completeInstance(
   const Linux_SambaGuestAccountForGlobalInstanceName& instanceName,
   CmpiInstance& target, const CmpiContext& ctx){
	  	
    Linux_SambaGuestAccountForGlobalInstanceName shadowInstanceName(instanceName);
  ...
  void CmpiLinux_SambaGuestAccountForGlobalProvider::copyShadowData (
  ...
  CmpiInstance* CmpiLinux_SambaGuestAccountForGlobalProvider::
  ...
  void CmpiLinux_SambaGuestAccountForGlobalProvider::removeDanglingShadowInstances (
   const Linux_SambaGuestAccountForGlobalInstanceNameEnumeration& dinInsNames){
  ...
  CMMethodMIFactory(
   CmpiLinux_SambaGuestAccountForGlobalProvider, CmpiLinux_SambaGuestAccountForGlobalProvider);
    ...
    CMAssociationMIFactory( CmpiLinux_SambaGuestAccountForGlobalProvider,
     CmpiLinux_SambaGuestAccountForGlobalProvider);
  ...
  CmpiStatus CmpiLinux_SambaGuestAccountForGlobalProvider::enumInstanceNames (
  ...
  CmpiStatus CmpiLinux_SambaGuestAccountForGlobalProvider::enumInstances (
   const CmpiContext& ctx, CmpiResult& rslt,
  ...
  CmpiStatus CmpiLinux_SambaGuestAccountForGlobalProvider::getInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, const char* *properties){
     	
    //covert to instanceName
    Linux_SambaGuestAccountForGlobalInstanceName instanceName(cop);
  ...
  CmpiStatus CmpiLinux_SambaGuestAccountForGlobalProvider::createInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
...
//      Linux_SambaGuestAccountForGlobalRepositoryInstance(inst,shadowNameSpaceP)
//      .getCmpiInstance(0);     
...
//       delete(backupShadowInstance);
  ...
  CmpiStatus CmpiLinux_SambaGuestAccountForGlobalProvider::setInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, const CmpiInstance& inst,
  ...
  CmpiStatus CmpiLinux_SambaGuestAccountForGlobalProvider::deleteInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop){
      
    Linux_SambaGuestAccountForGlobalInstanceName instanceName=
     Linux_SambaGuestAccountForGlobalInstanceName(cop);
  ...
  CmpiStatus CmpiLinux_SambaGuestAccountForGlobalProvider::invokeMethod (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& ref, const char* methodName,
   const CmpiArgs& in, CmpiArgs& out){
     	
    Linux_SambaGuestAccountForGlobalInstanceName instanceName=
     Linux_SambaGuestAccountForGlobalInstanceName(ref);
  ...
  CmpiStatus CmpiLinux_SambaGuestAccountForGlobalProvider::associationLogic( 
   ...
   const char** properties) {
    ...
    if( references == 0 && instances == 1 ) {
      ...
      while(enumeration.hasNext()) {
        ...
        const Linux_SambaGuestAccountForGlobalManualInstance manualInstance =
         enumeration.getNext();
  ...
  CmpiStatus CmpiLinux_SambaGuestAccountForGlobalProvider::associators (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, 
   ...
   const char** properties) {
    ...
    cout<<"calling associators() of class Linux_SambaGuestAccountForGlobal"<<endl;
  ...
  CmpiStatus CmpiLinux_SambaGuestAccountForGlobalProvider::associatorNames (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop,
   const char * assocClass, const char * resultClass,
   const char * role, const char * resultRole) {
   
    cout<<"calling associatorNames() of class Linux_SambaGuestAccountForGlobal"<<endl;
  ...
  CmpiStatus CmpiLinux_SambaGuestAccountForGlobalProvider::references ( 
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop,
   const char * assocClass, const char * role,
   const char** properties) {
    
    cout<<"calling references() of class Linux_SambaGuestAccountForGlobal"<<endl;
  ...
  CmpiStatus CmpiLinux_SambaGuestAccountForGlobalProvider::referenceNames (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop,
   const char * assocClass, const char * role) {
   
    cout<<"calling referenceNames() of class Linux_SambaGuestAccountForGlobal"<<endl;
