...
namespace genProvider {
  ...
  CmpiLinux_SambaGlobalProtocolOptionsProvider::
   ...
   const CmpiBroker &mbp, const CmpiContext& ctx):
    ...
    CmpiMethodMI(mbp,ctx), cppBroker(mbp) {
      ...
      interfaceP=Linux_SambaGlobalProtocolOptionsFactory::getImplementation();           
      cout<<"Provider was constructed"<<endl;
  };
    
        
  const char * CmpiLinux_SambaGlobalProtocolOptionsProvider::
  ...
  int CmpiLinux_SambaGlobalProtocolOptionsProvider::isUnloadable() const{
    return 0;
  }
  ...
  void CmpiLinux_SambaGlobalProtocolOptionsProvider::completeInstance(
   const Linux_SambaGlobalProtocolOptionsInstanceName& instanceName,
   CmpiInstance& target, const CmpiContext& ctx){
	  	
    Linux_SambaGlobalProtocolOptionsInstanceName shadowInstanceName(instanceName);
  ...
  void CmpiLinux_SambaGlobalProtocolOptionsProvider::copyShadowData (
  ...
  CmpiInstance* CmpiLinux_SambaGlobalProtocolOptionsProvider::
  ...
  void CmpiLinux_SambaGlobalProtocolOptionsProvider::removeDanglingShadowInstances (
  ...
  CmpiStatus CmpiLinux_SambaGlobalProtocolOptionsProvider::enumInstanceNames (
  ...
  CmpiStatus CmpiLinux_SambaGlobalProtocolOptionsProvider::enumInstances (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, const char* *properties){
    ...
    while ( enumeration.hasNext() ){
   	  ...
   	  const Linux_SambaGlobalProtocolOptionsManualInstance& instance=
       enumeration.getNext();
  ...
  CmpiStatus CmpiLinux_SambaGlobalProtocolOptionsProvider::getInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, const char* *properties){
     	
    //covert to instanceName
    Linux_SambaGlobalProtocolOptionsInstanceName instanceName(cop);
  ...
  CmpiStatus CmpiLinux_SambaGlobalProtocolOptionsProvider::createInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
...
//      Linux_SambaGlobalProtocolOptionsRepositoryInstance(inst,shadowNameSpaceP)
//      .getCmpiInstance(0);     
...
//       delete(backupShadowInstance);
  ...
  CmpiStatus CmpiLinux_SambaGlobalProtocolOptionsProvider::setInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, const CmpiInstance& inst,
...
//       delete(backupShadowInstance);
  ...
  CmpiStatus CmpiLinux_SambaGlobalProtocolOptionsProvider::deleteInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop){
      
    Linux_SambaGlobalProtocolOptionsInstanceName instanceName=
     Linux_SambaGlobalProtocolOptionsInstanceName(cop);
  ...
  CmpiStatus CmpiLinux_SambaGlobalProtocolOptionsProvider::invokeMethod (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& ref, const char* methodName,
   const CmpiArgs& in, CmpiArgs& out){
     	
    Linux_SambaGlobalProtocolOptionsInstanceName instanceName=
     Linux_SambaGlobalProtocolOptionsInstanceName(ref);
