...
#include "Linux_SambaGlobalProtocolOptionsFactory.h"
 ...
 namespace genProvider{
  ...
  class CmpiLinux_SambaGlobalProtocolOptionsProvider : public CmpiInstanceMI,
   public CmpiMethodMI{	
	
	private:

	Linux_SambaGlobalProtocolOptionsInterface* interfaceP;
	const static char * shadowNameSpaceP;
	CmpiBroker cppBroker;
	    
    void completeInstance (
     const Linux_SambaGlobalProtocolOptionsInstanceName& intanceNameP,
    ...
    CmpiInstance* getShadowInstance (
     ...
     const Linux_SambaGlobalProtocolOptionsInstanceName& intanceName);
	
    void removeDanglingShadowInstances (
     const Linux_SambaGlobalProtocolOptionsInstanceNameEnumeration& dinInsNames);
