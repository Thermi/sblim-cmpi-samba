...
namespace genProvider {
  ...
  CmpiLinux_SambaGlobalBrowseOptionsProvider::
   ...
   const CmpiBroker &mbp, const CmpiContext& ctx):
    ...
    CmpiMethodMI(mbp,ctx), cppBroker(mbp) {
      ...
      interfaceP=Linux_SambaGlobalBrowseOptionsFactory::getImplementation();           
      cout<<"Provider was constructed"<<endl;
  };
    
        
  const char * CmpiLinux_SambaGlobalBrowseOptionsProvider::
  ...
  int CmpiLinux_SambaGlobalBrowseOptionsProvider::isUnloadable() const{
    return 0;
  }
  ...
  void CmpiLinux_SambaGlobalBrowseOptionsProvider::completeInstance(
   const Linux_SambaGlobalBrowseOptionsInstanceName& instanceName,
   CmpiInstance& target, const CmpiContext& ctx){
	  	
    Linux_SambaGlobalBrowseOptionsInstanceName shadowInstanceName(instanceName);
  ...
  void CmpiLinux_SambaGlobalBrowseOptionsProvider::copyShadowData (
  ...
  CmpiInstance* CmpiLinux_SambaGlobalBrowseOptionsProvider::
  ...
  void CmpiLinux_SambaGlobalBrowseOptionsProvider::removeDanglingShadowInstances (
  ...
  CmpiStatus CmpiLinux_SambaGlobalBrowseOptionsProvider::enumInstanceNames (
  ...
  CmpiStatus CmpiLinux_SambaGlobalBrowseOptionsProvider::enumInstances (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, const char* *properties){
    ...
    while ( enumeration.hasNext() ){
   	  ...
   	  const Linux_SambaGlobalBrowseOptionsManualInstance& instance=
       enumeration.getNext();
  ...
  CmpiStatus CmpiLinux_SambaGlobalBrowseOptionsProvider::getInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, const char* *properties){
     	
    //covert to instanceName
    Linux_SambaGlobalBrowseOptionsInstanceName instanceName(cop);
  ...
  CmpiStatus CmpiLinux_SambaGlobalBrowseOptionsProvider::createInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
...
//      Linux_SambaGlobalBrowseOptionsRepositoryInstance(inst,shadowNameSpaceP)
//      .getCmpiInstance(0);     
...
//       delete(backupShadowInstance);
  ...
  CmpiStatus CmpiLinux_SambaGlobalBrowseOptionsProvider::setInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, const CmpiInstance& inst,
...
//       delete(backupShadowInstance);
  ...
  CmpiStatus CmpiLinux_SambaGlobalBrowseOptionsProvider::deleteInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop){
      
    Linux_SambaGlobalBrowseOptionsInstanceName instanceName=
     Linux_SambaGlobalBrowseOptionsInstanceName(cop);
  ...
  CmpiStatus CmpiLinux_SambaGlobalBrowseOptionsProvider::invokeMethod (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& ref, const char* methodName,
   const CmpiArgs& in, CmpiArgs& out){
     	
    Linux_SambaGlobalBrowseOptionsInstanceName instanceName=
     Linux_SambaGlobalBrowseOptionsInstanceName(ref);
