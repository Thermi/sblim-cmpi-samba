...
#include "Linux_SambaGlobalBrowseOptionsFactory.h"
 ...
 namespace genProvider{
  ...
  class CmpiLinux_SambaGlobalBrowseOptionsProvider : public CmpiInstanceMI,
   public CmpiMethodMI{	
	
	private:

	Linux_SambaGlobalBrowseOptionsInterface* interfaceP;
	const static char * shadowNameSpaceP;
	CmpiBroker cppBroker;
	    
    void completeInstance (
     const Linux_SambaGlobalBrowseOptionsInstanceName& intanceNameP,
    ...
    CmpiInstance* getShadowInstance (
     ...
     const Linux_SambaGlobalBrowseOptionsInstanceName& intanceName);
	
    void removeDanglingShadowInstances (
     const Linux_SambaGlobalBrowseOptionsInstanceNameEnumeration& dinInsNames);
