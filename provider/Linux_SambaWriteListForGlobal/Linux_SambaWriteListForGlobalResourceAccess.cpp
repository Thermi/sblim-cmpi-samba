...
namespace genProvider {
  ...
  Linux_SambaWriteListForGlobalResourceAccess::~Linux_SambaWriteListForGlobalResourceAccess() { 
    ...
    /* intrinsic methods */
  void Linux_SambaWriteListForGlobalResourceAccess::enumInstanceNames(
  ...
  void Linux_SambaWriteListForGlobalResourceAccess::enumInstances(
   ...
   const Linux_SambaWriteListForGlobalInstanceName& instanceName)
  {
    ...
    return aManualInstance;
  	...
  	/*
    void Linux_SambaWriteListForGlobalResourceAccess::setInstance(
     const CmpiContext& ctx,
     const CmpiBroker &mbp,
     const char* *properties,
  ...
  bool Linux_SambaWriteListForGlobalResourceAccess::validUser(const char* user)
  {
  ...
  void Linux_SambaWriteListForGlobalResourceAccess::createInstance(
   const CmpiContext& ctx, const CmpiBroker &mbp,
   const Linux_SambaWriteListForGlobalManualInstance& newInstance)
  {
  ...
  void Linux_SambaWriteListForGlobalResourceAccess::deleteInstance(
   const CmpiContext& ctx, const CmpiBroker &mbp,
   const Linux_SambaWriteListForGlobalInstanceName& instanceName)
  {
    SambaArray array = SambaArray();
  ...
  void Linux_SambaWriteListForGlobalResourceAccess::referencesPartComponent( 
   ...
   Linux_SambaWriteListForGlobalManualInstanceEnumeration& instEnum)
  {
