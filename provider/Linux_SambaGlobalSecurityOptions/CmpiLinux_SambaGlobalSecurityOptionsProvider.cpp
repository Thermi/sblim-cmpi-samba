...
namespace genProvider {
  ...
  CmpiLinux_SambaGlobalSecurityOptionsProvider::
   ...
   const CmpiBroker &mbp, const CmpiContext& ctx):
    ...
    CmpiMethodMI(mbp,ctx), cppBroker(mbp) {
      ...
      interfaceP=Linux_SambaGlobalSecurityOptionsFactory::getImplementation();           
      cout<<"Provider was constructed"<<endl;
  };
    
        
  const char * CmpiLinux_SambaGlobalSecurityOptionsProvider::
  ...
  int CmpiLinux_SambaGlobalSecurityOptionsProvider::isUnloadable() const{
    return 0;
  }
  ...
  void CmpiLinux_SambaGlobalSecurityOptionsProvider::completeInstance(
   const Linux_SambaGlobalSecurityOptionsInstanceName& instanceName,
   CmpiInstance& target, const CmpiContext& ctx){
	  	
    Linux_SambaGlobalSecurityOptionsInstanceName shadowInstanceName(instanceName);
  ...
  void CmpiLinux_SambaGlobalSecurityOptionsProvider::copyShadowData (
  ...
  CmpiInstance* CmpiLinux_SambaGlobalSecurityOptionsProvider::
  ...
  void CmpiLinux_SambaGlobalSecurityOptionsProvider::removeDanglingShadowInstances (
   const Linux_SambaGlobalSecurityOptionsInstanceNameEnumeration& dinInsNames){
  ...
  CmpiStatus CmpiLinux_SambaGlobalSecurityOptionsProvider::enumInstanceNames (
  ...
  CmpiStatus CmpiLinux_SambaGlobalSecurityOptionsProvider::enumInstances (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, const char* *properties){
    ...
    while ( enumeration.hasNext() ){
   	  ...
   	  const Linux_SambaGlobalSecurityOptionsManualInstance& instance=
       enumeration.getNext();
  ...
  CmpiStatus CmpiLinux_SambaGlobalSecurityOptionsProvider::getInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, const char* *properties){
     	
    //covert to instanceName
    Linux_SambaGlobalSecurityOptionsInstanceName instanceName(cop);
  ...
  CmpiStatus CmpiLinux_SambaGlobalSecurityOptionsProvider::createInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
...
//      Linux_SambaGlobalSecurityOptionsRepositoryInstance(inst,shadowNameSpaceP)
//      .getCmpiInstance(0);     
...
//       delete(backupShadowInstance);
  ...
  CmpiStatus CmpiLinux_SambaGlobalSecurityOptionsProvider::setInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, const CmpiInstance& inst,
...
//       delete(backupShadowInstance);
  ...
  CmpiStatus CmpiLinux_SambaGlobalSecurityOptionsProvider::deleteInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop){
      
    Linux_SambaGlobalSecurityOptionsInstanceName instanceName=
     Linux_SambaGlobalSecurityOptionsInstanceName(cop);
  ...
  CmpiStatus CmpiLinux_SambaGlobalSecurityOptionsProvider::invokeMethod (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& ref, const char* methodName,
   const CmpiArgs& in, CmpiArgs& out){
     	
    Linux_SambaGlobalSecurityOptionsInstanceName instanceName=
     Linux_SambaGlobalSecurityOptionsInstanceName(ref);
