...
#include "Linux_SambaGlobalSecurityOptionsFactory.h"
 ...
 namespace genProvider{
  ...
  class CmpiLinux_SambaGlobalSecurityOptionsProvider : public CmpiInstanceMI,
   public CmpiMethodMI{	
	
	private:

	Linux_SambaGlobalSecurityOptionsInterface* interfaceP;
	const static char * shadowNameSpaceP;
	CmpiBroker cppBroker;
	    
    void completeInstance (
     const Linux_SambaGlobalSecurityOptionsInstanceName& intanceNameP,
    ...
    CmpiInstance* getShadowInstance (
     ...
     const Linux_SambaGlobalSecurityOptionsInstanceName& intanceName);
