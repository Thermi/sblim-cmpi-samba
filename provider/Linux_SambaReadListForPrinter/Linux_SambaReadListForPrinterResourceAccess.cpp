...
namespace genProvider {
   ...
   void Linux_SambaReadListForPrinterResourceAccess::enumInstanceNames(
  ...
  void Linux_SambaReadListForPrinterResourceAccess::enumInstances(
   ...
   const Linux_SambaReadListForPrinterInstanceName& instanceName)
  {
    ...
    return aManualInstance;
  	...
  	/*
    void Linux_SambaReadListForPrinterResourceAccess::setInstance(
     const CmpiContext& ctx,
     const CmpiBroker &mbp,
     const char* *properties,
  ...
  void Linux_SambaReadListForPrinterResourceAccess::createInstance(
   const CmpiContext& ctx, const CmpiBroker &mbp,
   const Linux_SambaReadListForPrinterManualInstance& newInstance)
  {
    ...
    set_printer_option(newInstance.getInstanceName().getGroupComponent().getName(),"read list",array.toString().c_str());
      } 	
    }
  };
  	
  void Linux_SambaReadListForPrinterResourceAccess::deleteInstance(
   const CmpiContext& ctx, const CmpiBroker &mbp,
   const Linux_SambaReadListForPrinterInstanceName& instanceName)
  {
    SambaArray array = SambaArray();
    ...
    if(array.size() > 1){
      ...
      set_printer_option(instanceName.getGroupComponent().getName(),"read list",array.toString().c_str());
    }
    else
      set_printer_option(instanceName.getGroupComponent().getName(),"read list",NULL);
  }	
  ...
  void Linux_SambaReadListForPrinterResourceAccess::referencesPartComponent( 
   ...
   Linux_SambaReadListForPrinterManualInstanceEnumeration& instEnum)
  {
