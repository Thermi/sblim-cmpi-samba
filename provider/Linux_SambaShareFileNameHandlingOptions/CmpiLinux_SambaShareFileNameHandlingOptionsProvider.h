...
#include "Linux_SambaShareFileNameHandlingOptionsFactory.h"
 ...
 namespace genProvider{
  ...
  class CmpiLinux_SambaShareFileNameHandlingOptionsProvider : public CmpiInstanceMI,
   public CmpiMethodMI{	
	
	private:

	Linux_SambaShareFileNameHandlingOptionsInterface* interfaceP;
	const static char * shadowNameSpaceP;
	CmpiBroker cppBroker;
	    
    void completeInstance (
     const Linux_SambaShareFileNameHandlingOptionsInstanceName& intanceNameP,
    ...
    CmpiInstance* getShadowInstance (
     ...
     const Linux_SambaShareFileNameHandlingOptionsInstanceName& intanceName);
