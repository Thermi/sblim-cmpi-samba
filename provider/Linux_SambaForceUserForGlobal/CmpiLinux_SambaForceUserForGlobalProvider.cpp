...
namespace genProvider {
  ...
  CmpiLinux_SambaForceUserForGlobalProvider::
   ...
   const CmpiBroker &mbp, const CmpiContext& ctx):
    ...
    CmpiMethodMI(mbp,ctx), CmpiAssociationMI(mbp,ctx), cppBroker(mbp) {
      ...
      interfaceP=Linux_SambaForceUserForGlobalFactory::getImplementation();           
      cout<<"Provider was constructed"<<endl;
  };
    
        
  const char * CmpiLinux_SambaForceUserForGlobalProvider::
  ...
  int CmpiLinux_SambaForceUserForGlobalProvider::isUnloadable() const{
    return 0;
  }
  ...
  void CmpiLinux_SambaForceUserForGlobalProvider::completeInstance(
   const Linux_SambaForceUserForGlobalInstanceName& instanceName,
   CmpiInstance& target, const CmpiContext& ctx){
	  	
    Linux_SambaForceUserForGlobalInstanceName shadowInstanceName(instanceName);
  ...
  void CmpiLinux_SambaForceUserForGlobalProvider::copyShadowData (
  ...
  CmpiInstance* CmpiLinux_SambaForceUserForGlobalProvider::
  ...
  void CmpiLinux_SambaForceUserForGlobalProvider::removeDanglingShadowInstances (
  ...
  CMMethodMIFactory(
   CmpiLinux_SambaForceUserForGlobalProvider, CmpiLinux_SambaForceUserForGlobalProvider);
    ...
    CMAssociationMIFactory( CmpiLinux_SambaForceUserForGlobalProvider,
     CmpiLinux_SambaForceUserForGlobalProvider);
  ...
  CmpiStatus CmpiLinux_SambaForceUserForGlobalProvider::enumInstanceNames (
  ...
  CmpiStatus CmpiLinux_SambaForceUserForGlobalProvider::enumInstances (
   const CmpiContext& ctx, CmpiResult& rslt,
  ...
  CmpiStatus CmpiLinux_SambaForceUserForGlobalProvider::getInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, const char* *properties){
     	
    //covert to instanceName
    Linux_SambaForceUserForGlobalInstanceName instanceName(cop);
  ...
  CmpiStatus CmpiLinux_SambaForceUserForGlobalProvider::createInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
...
//      Linux_SambaForceUserForGlobalRepositoryInstance(inst,shadowNameSpaceP)
//      .getCmpiInstance(0);     
...
//       delete(backupShadowInstance);
  ...
  CmpiStatus CmpiLinux_SambaForceUserForGlobalProvider::setInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, const CmpiInstance& inst,
  ...
  CmpiStatus CmpiLinux_SambaForceUserForGlobalProvider::deleteInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop){
      
    Linux_SambaForceUserForGlobalInstanceName instanceName=
     Linux_SambaForceUserForGlobalInstanceName(cop);
  ...
  CmpiStatus CmpiLinux_SambaForceUserForGlobalProvider::invokeMethod (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& ref, const char* methodName,
   const CmpiArgs& in, CmpiArgs& out){
     	
    Linux_SambaForceUserForGlobalInstanceName instanceName=
     Linux_SambaForceUserForGlobalInstanceName(ref);
  ...
  CmpiStatus CmpiLinux_SambaForceUserForGlobalProvider::associationLogic( 
   ...
   const char** properties) {
    ...
    if( references == 0 && instances == 1 ) {
      ...
      while(enumeration.hasNext()) {
        ...
        const Linux_SambaForceUserForGlobalManualInstance manualInstance =
         enumeration.getNext();
  ...
  CmpiStatus CmpiLinux_SambaForceUserForGlobalProvider::associators (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, 
   ...
   const char** properties) {
    ...
    cout<<"calling associators() of class Linux_SambaForceUserForGlobal"<<endl;
  ...
  CmpiStatus CmpiLinux_SambaForceUserForGlobalProvider::associatorNames (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop,
   const char * assocClass, const char * resultClass,
   const char * role, const char * resultRole) {
   
    cout<<"calling associatorNames() of class Linux_SambaForceUserForGlobal"<<endl;
  ...
  CmpiStatus CmpiLinux_SambaForceUserForGlobalProvider::references ( 
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop,
   const char * assocClass, const char * role,
   const char** properties) {
    
    cout<<"calling references() of class Linux_SambaForceUserForGlobal"<<endl;
  ...
  CmpiStatus CmpiLinux_SambaForceUserForGlobalProvider::referenceNames (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop,
   const char * assocClass, const char * role) {
   
    cout<<"calling referenceNames() of class Linux_SambaForceUserForGlobal"<<endl;
