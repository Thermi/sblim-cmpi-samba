...
namespace genProvider {
  ...
  class Linux_SambaScriptingForGlobalInterface {
    ...
    virtual void enumInstanceNames(
     ...
     const char *nsp,
     Linux_SambaScriptingForGlobalInstanceNameEnumeration& instnames) = 0;
    ...
    virtual void enumInstances(
     ...
     const char* *properties,
  	 Linux_SambaScriptingForGlobalManualInstanceEnumeration& instances) = 0;
  	
    virtual Linux_SambaScriptingForGlobalManualInstance getInstance(
     const CmpiContext& ctx,
     const CmpiBroker &mbp,
     const char* *properties,
     const Linux_SambaScriptingForGlobalInstanceName&) = 0;
  	
    virtual void setInstance(
     const CmpiContext& ctx,
     const CmpiBroker &mbp,
     const char* *properties,
     const Linux_SambaScriptingForGlobalManualInstance&) = 0;
    ...
    virtual void associatorsSettingData( 
     ...
     const char** properties,
     const Linux_SambaGlobalOptionsInstanceName& sourceInst,
     Linux_SambaScriptingOptionsInstanceEnumeration& instances) = 0;
