...
namespace genProvider {
  ...
  CmpiLinux_SambaScriptingForGlobalProvider::
   ...
   const CmpiBroker &mbp, const CmpiContext& ctx):
    ...
    CmpiMethodMI(mbp,ctx), CmpiAssociationMI(mbp,ctx), cppBroker(mbp) {
      ...
      interfaceP=Linux_SambaScriptingForGlobalFactory::getImplementation();           
      cout<<"Provider was constructed"<<endl;
  };
    
        
  const char * CmpiLinux_SambaScriptingForGlobalProvider::
  ...
  int CmpiLinux_SambaScriptingForGlobalProvider::isUnloadable() const{
    return 0;
  }
  ...
  void CmpiLinux_SambaScriptingForGlobalProvider::completeInstance(
   const Linux_SambaScriptingForGlobalInstanceName& instanceName,
   CmpiInstance& target, const CmpiContext& ctx){
	  	
    Linux_SambaScriptingForGlobalInstanceName shadowInstanceName(instanceName);
  ...
  void CmpiLinux_SambaScriptingForGlobalProvider::copyShadowData (
  ...
  CmpiInstance* CmpiLinux_SambaScriptingForGlobalProvider::
  ...
  void CmpiLinux_SambaScriptingForGlobalProvider::removeDanglingShadowInstances (
  ...
  CMMethodMIFactory(
   CmpiLinux_SambaScriptingForGlobalProvider, CmpiLinux_SambaScriptingForGlobalProvider);
    ...
    CMAssociationMIFactory( CmpiLinux_SambaScriptingForGlobalProvider,
     CmpiLinux_SambaScriptingForGlobalProvider);
  ...
  CmpiStatus CmpiLinux_SambaScriptingForGlobalProvider::enumInstanceNames (
  ...
  CmpiStatus CmpiLinux_SambaScriptingForGlobalProvider::enumInstances (
   const CmpiContext& ctx, CmpiResult& rslt,
  ...
  CmpiStatus CmpiLinux_SambaScriptingForGlobalProvider::getInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, const char* *properties){
     	
    //covert to instanceName
    Linux_SambaScriptingForGlobalInstanceName instanceName(cop);
  ...
  CmpiStatus CmpiLinux_SambaScriptingForGlobalProvider::createInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop,const CmpiInstance& inst){
    ...
    CmpiInstance* backupShadowInstance=0;
     ...
     Linux_SambaScriptingForGlobalRepositoryInstance(inst,shadowNameSpaceP)
     .getCmpiInstance(0);     
  ...
  CmpiStatus CmpiLinux_SambaScriptingForGlobalProvider::setInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, const CmpiInstance& inst,
  ...
  CmpiStatus CmpiLinux_SambaScriptingForGlobalProvider::deleteInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop){
      
    Linux_SambaScriptingForGlobalInstanceName instanceName=
     Linux_SambaScriptingForGlobalInstanceName(cop);
  ...
  CmpiStatus CmpiLinux_SambaScriptingForGlobalProvider::invokeMethod (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& ref, const char* methodName,
   const CmpiArgs& in, CmpiArgs& out){
     	
    Linux_SambaScriptingForGlobalInstanceName instanceName=
     Linux_SambaScriptingForGlobalInstanceName(ref);
  ...
  CmpiStatus CmpiLinux_SambaScriptingForGlobalProvider::associationLogic( 
   ...
   const char** properties) {
    ...
    if( references == 0 && instances == 1 ) {
      ...
      else if(cop.classPathIsA("Linux_SambaScriptingOptions")) {
        Linux_SambaGlobalOptionsInstanceEnumeration enumeration;
        Linux_SambaScriptingOptionsInstanceName SettingData(cop);
      ...
      if(cop.classPathIsA("Linux_SambaScriptingOptions")) {
        Linux_SambaScriptingOptionsInstanceName SettingData(cop);
      ...
      while(enumeration.hasNext()) {
        ...
        const Linux_SambaScriptingForGlobalManualInstance manualInstance =
         enumeration.getNext();
  ...
  CmpiStatus CmpiLinux_SambaScriptingForGlobalProvider::associators (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, 
   ...
   const char** properties) {
    ...
    cout<<"calling associators() of class Linux_SambaScriptingForGlobal"<<endl;
  ...
  CmpiStatus CmpiLinux_SambaScriptingForGlobalProvider::associatorNames (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop,
   const char * assocClass, const char * resultClass,
   const char * role, const char * resultRole) {
   
    cout<<"calling associatorNames() of class Linux_SambaScriptingForGlobal"<<endl;
  ...
  CmpiStatus CmpiLinux_SambaScriptingForGlobalProvider::references ( 
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop,
   const char * assocClass, const char * role,
   const char** properties) {
    
    cout<<"calling references() of class Linux_SambaScriptingForGlobal"<<endl;
  ...
  CmpiStatus CmpiLinux_SambaScriptingForGlobalProvider::referenceNames (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop,
   const char * assocClass, const char * role) {
   
    cout<<"calling referenceNames() of class Linux_SambaScriptingForGlobal"<<endl;
