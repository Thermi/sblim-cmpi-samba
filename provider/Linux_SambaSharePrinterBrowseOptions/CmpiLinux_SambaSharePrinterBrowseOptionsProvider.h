...
namespace genProvider{
  ...
  class CmpiLinux_SambaSharePrinterBrowseOptionsProvider : 
    public CmpiInstanceMI,
    public CmpiMethodMI {	
	
	  private:
	  Linux_SambaSharePrinterBrowseOptionsInterface* m_interfaceP;
	  CmpiBroker m_cmpiBroker;
	    
	  private:

    void completeInstance(
      const Linux_SambaSharePrinterBrowseOptionsInstanceName& anInstanceNameP,
    ...
    void removeDanglingShadowInstances (
      const Linux_SambaSharePrinterBrowseOptionsInstanceNameEnumeration& anInstanceNameEnumeration);
