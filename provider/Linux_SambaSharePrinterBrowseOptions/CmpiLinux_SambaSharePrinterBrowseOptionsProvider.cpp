...
namespace genProvider {
  ...
  CmpiLinux_SambaSharePrinterBrowseOptionsProvider::CmpiLinux_SambaSharePrinterBrowseOptionsProvider(
    ...
    m_interfaceP = Linux_SambaSharePrinterBrowseOptionsFactory::getImplementation();           
  ...
  //----------------------------------------------------------------------------
  int 
  CmpiLinux_SambaSharePrinterBrowseOptionsProvider::isUnloadable() const {
    return 0;
  }
	
  //----------------------------------------------------------------------------
  void 
  CmpiLinux_SambaSharePrinterBrowseOptionsProvider::completeInstance(
    const Linux_SambaSharePrinterBrowseOptionsInstanceName& anInstanceName,
    CmpiInstance& anInstance, 
    const CmpiContext& aContext) {
	  	
    Linux_SambaSharePrinterBrowseOptionsInstanceName shadowInstanceName(anInstanceName);
  ...
  //----------------------------------------------------------------------------
  void 
  CmpiLinux_SambaSharePrinterBrowseOptionsProvider::copyShadowData(
  ...
  //----------------------------------------------------------------------------
  CmpiInstance* 
  CmpiLinux_SambaSharePrinterBrowseOptionsProvider::getShadowInstance(
  ...
  //----------------------------------------------------------------------------
  void
  CmpiLinux_SambaSharePrinterBrowseOptionsProvider::removeDanglingShadowInstances (
   const Linux_SambaSharePrinterBrowseOptionsInstanceNameEnumeration& anInstanceNameEnumerations) {
  ...
  //----------------------------------------------------------------------------
  CmpiStatus 
  CmpiLinux_SambaSharePrinterBrowseOptionsProvider::enumInstanceNames(
    const CmpiContext& aContext, 
    CmpiResult& aResult,
    ...
    while (enumeration.hasNext() ){
      const Linux_SambaSharePrinterBrowseOptionsInstanceName& instanceName = enumeration.getNext();
  ...
  //----------------------------------------------------------------------------
  CmpiStatus 
  CmpiLinux_SambaSharePrinterBrowseOptionsProvider::enumInstances(
    const CmpiContext& aContext,
    CmpiResult& aResult,
    const CmpiObjectPath& aCop, 
    ...
    while (enumeration.hasNext()) {
   	  const Linux_SambaSharePrinterBrowseOptionsManualInstance& instance = enumeration.getNext();
  ...
  //----------------------------------------------------------------------------
  CmpiStatus 
  CmpiLinux_SambaSharePrinterBrowseOptionsProvider::getInstance (
    const CmpiContext& aContext, 
    CmpiResult& aResult,
    const CmpiObjectPath& aCop,
    const char** aPropertiesPP) {
    ...
    Linux_SambaSharePrinterBrowseOptionsInstanceName instanceName(aCop);
  ...
  //----------------------------------------------------------------------------
  CmpiStatus 
  CmpiLinux_SambaSharePrinterBrowseOptionsProvider::createInstance (
    const CmpiContext& aContext,
    CmpiResult& aResult,
    const CmpiObjectPath& aCop,
    const CmpiInstance& aCmpiInstance) {
   	
   	Linux_SambaSharePrinterBrowseOptionsManualInstance manualInstance(
      aCmpiInstance,
...
//   	  Linux_SambaSharePrinterBrowseOptionsRepositoryInstance(aCmpiInstance,"IBMShadow/cimv2").getCmpiInstance(0);     
//     
...
//    }
  ...
  //----------------------------------------------------------------------------
  CmpiStatus 
  CmpiLinux_SambaSharePrinterBrowseOptionsProvider::setInstance (
    const CmpiContext& aContext,
    CmpiResult& aResult,
    const CmpiObjectPath& aCop,
    const CmpiInstance& aCmpiInstance,
...
//    }
  ...
  //----------------------------------------------------------------------------
  CmpiStatus
  CmpiLinux_SambaSharePrinterBrowseOptionsProvider::deleteInstance(
    const CmpiContext& aContext,
    CmpiResult& aResult,
    const CmpiObjectPath& aCop) {
      
    Linux_SambaSharePrinterBrowseOptionsInstanceName instanceName = Linux_SambaSharePrinterBrowseOptionsInstanceName(aCop);
  ...
  //----------------------------------------------------------------------------
  CmpiStatus
  CmpiLinux_SambaSharePrinterBrowseOptionsProvider::invokeMethod(
    const CmpiContext& aContext,
    CmpiResult& aResult,
    const CmpiObjectPath& aCop,
