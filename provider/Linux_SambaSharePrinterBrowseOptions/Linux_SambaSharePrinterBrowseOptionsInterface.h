...
namespace genProvider {
  ...
  class Linux_SambaSharePrinterBrowseOptionsInterface {
    ...
    virtual void enumInstanceNames(
      ...
      Linux_SambaSharePrinterBrowseOptionsInstanceNameEnumeration& anInstanceNameEnumeration) = 0;
    ...
    virtual void enumInstances(
      ...
      const char** aPropertiesPP,
  	  Linux_SambaSharePrinterBrowseOptionsManualInstanceEnumeration& aManualInstanceEnumeration) = 0;
    ...
    virtual Linux_SambaSharePrinterBrowseOptionsManualInstance getInstance(
      ...
      const CmpiBroker& aBroker,
      const char** aPropertiesPP,
      const Linux_SambaSharePrinterBrowseOptionsInstanceName& anInstanceName) = 0;
    ...
    virtual void setInstance(
      ...
      const CmpiBroker& aBroker,
      const char** aPropertiesPP,
      const Linux_SambaSharePrinterBrowseOptionsManualInstance& aManualInstance) = 0;
