...
namespace genProvider {
  ...
  Linux_SambaSharePrinterBrowseOptionsExternal::~Linux_SambaSharePrinterBrowseOptionsExternal() { }
	...
	//----------------------------------------------------------------------------
  void 
  Linux_SambaSharePrinterBrowseOptionsExternal::enumInstanceNames(
    const char *aNameSpaceP,
    Linux_SambaSharePrinterBrowseOptionsInstanceNameEnumeration& anInstanceNameEnumeration) {

    CmpiObjectPath classObjectPath(aNameSpaceP,"Linux_SambaSharePrinterBrowseOptions");
    CmpiEnumeration cmpiEnumeration = 
      m_broker.enumInstanceNames(m_context,classObjectPath);
    while (cmpiEnumeration.hasNext()) {
      CmpiObjectPath objectPath = cmpiEnumeration.getNext();
      Linux_SambaSharePrinterBrowseOptionsInstanceName instanceName(objectPath);
  ...
  //----------------------------------------------------------------------------
  void
  Linux_SambaSharePrinterBrowseOptionsExternal::enumInstances(
    const char *aNameSpaceP,
  ...
  Linux_SambaSharePrinterBrowseOptionsExternal::getInstance(
    ...
    return Linux_SambaSharePrinterBrowseOptionsInstance(cmpiInstance,anInstanceName.getNamespace());
  
  }
      
	//----------------------------------------------------------------------------
  void
  Linux_SambaSharePrinterBrowseOptionsExternal::setInstance(
    const char** aPropertiesPP,
  ...
  Linux_SambaSharePrinterBrowseOptionsExternal::createInstance(
    const Linux_SambaSharePrinterBrowseOptionsInstance& anInstance) {
	...
	//----------------------------------------------------------------------------
  void
  Linux_SambaSharePrinterBrowseOptionsExternal::deleteInstance(
    const Linux_SambaSharePrinterBrowseOptionsInstanceName& anInstanceName) {
