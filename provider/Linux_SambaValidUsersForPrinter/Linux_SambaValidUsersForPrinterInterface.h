...
namespace genProvider {
  ...
  class Linux_SambaValidUsersForPrinterInterface {
    ...
    virtual void enumInstanceNames(
     ...
     const char *nsp,
     Linux_SambaValidUsersForPrinterInstanceNameEnumeration& instnames) = 0;
    ...
    virtual void enumInstances(
     ...
     const char* *properties,
  	 Linux_SambaValidUsersForPrinterManualInstanceEnumeration& instances) = 0;
  	
    virtual Linux_SambaValidUsersForPrinterManualInstance getInstance(
     const CmpiContext& ctx,
     const CmpiBroker &mbp,
     const char* *properties,
     const Linux_SambaValidUsersForPrinterInstanceName&) = 0;
  	
    virtual void setInstance(
     const CmpiContext& ctx,
     const CmpiBroker &mbp,
     const char* *properties,
     const Linux_SambaValidUsersForPrinterManualInstance&) = 0;
