...
namespace genProvider {
  ...
  CmpiLinux_SambaValidUsersForPrinterProvider::
   ...
   const CmpiBroker &mbp, const CmpiContext& ctx):
    ...
    CmpiMethodMI(mbp,ctx), CmpiAssociationMI(mbp,ctx), cppBroker(mbp) {
      ...
      interfaceP=Linux_SambaValidUsersForPrinterFactory::getImplementation();           
      cout<<"Provider was constructed"<<endl;
  };
    
        
  const char * CmpiLinux_SambaValidUsersForPrinterProvider::
  ...
  int CmpiLinux_SambaValidUsersForPrinterProvider::isUnloadable() const{
    return 0;
  }
  ...
  void CmpiLinux_SambaValidUsersForPrinterProvider::completeInstance(
   const Linux_SambaValidUsersForPrinterInstanceName& instanceName,
   CmpiInstance& target, const CmpiContext& ctx){
	  	
    Linux_SambaValidUsersForPrinterInstanceName shadowInstanceName(instanceName);
  ...
  void CmpiLinux_SambaValidUsersForPrinterProvider::copyShadowData (
  ...
  CmpiInstance* CmpiLinux_SambaValidUsersForPrinterProvider::
  ...
  void CmpiLinux_SambaValidUsersForPrinterProvider::removeDanglingShadowInstances (
   const Linux_SambaValidUsersForPrinterInstanceNameEnumeration& dinInsNames){
  ...
  CMMethodMIFactory(
   CmpiLinux_SambaValidUsersForPrinterProvider, CmpiLinux_SambaValidUsersForPrinterProvider);
    ...
    CMAssociationMIFactory( CmpiLinux_SambaValidUsersForPrinterProvider,
     CmpiLinux_SambaValidUsersForPrinterProvider);
  ...
  CmpiStatus CmpiLinux_SambaValidUsersForPrinterProvider::enumInstanceNames (
  ...
  CmpiStatus CmpiLinux_SambaValidUsersForPrinterProvider::enumInstances (
   const CmpiContext& ctx, CmpiResult& rslt,
  ...
  CmpiStatus CmpiLinux_SambaValidUsersForPrinterProvider::getInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, const char* *properties){
     	
    //covert to instanceName
    Linux_SambaValidUsersForPrinterInstanceName instanceName(cop);
  ...
  CmpiStatus CmpiLinux_SambaValidUsersForPrinterProvider::createInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
...
//      Linux_SambaValidUsersForPrinterRepositoryInstance(inst,shadowNameSpaceP)
//      .getCmpiInstance(0);     
...
//       delete(backupShadowInstance);
  ...
  CmpiStatus CmpiLinux_SambaValidUsersForPrinterProvider::setInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, const CmpiInstance& inst,
  ...
  CmpiStatus CmpiLinux_SambaValidUsersForPrinterProvider::deleteInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop){
      
    Linux_SambaValidUsersForPrinterInstanceName instanceName=
     Linux_SambaValidUsersForPrinterInstanceName(cop);
  ...
  CmpiStatus CmpiLinux_SambaValidUsersForPrinterProvider::invokeMethod (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& ref, const char* methodName,
   const CmpiArgs& in, CmpiArgs& out){
     	
    Linux_SambaValidUsersForPrinterInstanceName instanceName=
     Linux_SambaValidUsersForPrinterInstanceName(ref);
  ...
  CmpiStatus CmpiLinux_SambaValidUsersForPrinterProvider::associationLogic( 
   ...
   const char** properties) {
    ...
    if( references == 0 && instances == 1 ) {
      ...
      while(enumeration.hasNext()) {
        ...
        const Linux_SambaValidUsersForPrinterManualInstance manualInstance =
         enumeration.getNext();
  ...
  CmpiStatus CmpiLinux_SambaValidUsersForPrinterProvider::associators (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, 
   ...
   const char** properties) {
    ...
    cout<<"calling associators() of class Linux_SambaValidUsersForPrinter"<<endl;
  ...
  CmpiStatus CmpiLinux_SambaValidUsersForPrinterProvider::associatorNames (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop,
   const char * assocClass, const char * resultClass,
   const char * role, const char * resultRole) {
   
    cout<<"calling associatorNames() of class Linux_SambaValidUsersForPrinter"<<endl;
  ...
  CmpiStatus CmpiLinux_SambaValidUsersForPrinterProvider::references ( 
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop,
   const char * assocClass, const char * role,
   const char** properties) {
    
    cout<<"calling references() of class Linux_SambaValidUsersForPrinter"<<endl;
  ...
  CmpiStatus CmpiLinux_SambaValidUsersForPrinterProvider::referenceNames (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop,
   const char * assocClass, const char * role) {
   
    cout<<"calling referenceNames() of class Linux_SambaValidUsersForPrinter"<<endl;
