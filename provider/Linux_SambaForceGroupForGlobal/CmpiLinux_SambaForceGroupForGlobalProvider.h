...
#include "CmpiAssociationMI.h"
 ...
 namespace genProvider{
  ...
  class CmpiLinux_SambaForceGroupForGlobalProvider : public CmpiInstanceMI,
   public CmpiMethodMI, public CmpiAssociationMI{	
	
	private:

	Linux_SambaForceGroupForGlobalInterface* interfaceP;
	const static char * shadowNameSpaceP;
	CmpiBroker cppBroker;
	    
    void completeInstance (
     const Linux_SambaForceGroupForGlobalInstanceName& intanceNameP,
    ...
    CmpiInstance* getShadowInstance (
     ...
     const Linux_SambaForceGroupForGlobalInstanceName& intanceName);
	
    void removeDanglingShadowInstances (
     const Linux_SambaForceGroupForGlobalInstanceNameEnumeration& dinInsNames);
