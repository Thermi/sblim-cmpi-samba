...
namespace genProvider {
  ...
  CmpiLinux_SambaForceGroupForGlobalProvider::
   ...
   const CmpiBroker &mbp, const CmpiContext& ctx):
    ...
    CmpiMethodMI(mbp,ctx), CmpiAssociationMI(mbp,ctx), cppBroker(mbp) {
      ...
      interfaceP=Linux_SambaForceGroupForGlobalFactory::getImplementation();           
      cout<<"Provider was constructed"<<endl;
  };
    
        
  const char * CmpiLinux_SambaForceGroupForGlobalProvider::
  ...
  int CmpiLinux_SambaForceGroupForGlobalProvider::isUnloadable() const{
    return 0;
  }
  ...
  void CmpiLinux_SambaForceGroupForGlobalProvider::completeInstance(
   const Linux_SambaForceGroupForGlobalInstanceName& instanceName,
   CmpiInstance& target, const CmpiContext& ctx){
	  	
    Linux_SambaForceGroupForGlobalInstanceName shadowInstanceName(instanceName);
  ...
  void CmpiLinux_SambaForceGroupForGlobalProvider::copyShadowData (
  ...
  CmpiInstance* CmpiLinux_SambaForceGroupForGlobalProvider::
  ...
  void CmpiLinux_SambaForceGroupForGlobalProvider::removeDanglingShadowInstances (
  ...
  CMMethodMIFactory(
   CmpiLinux_SambaForceGroupForGlobalProvider, CmpiLinux_SambaForceGroupForGlobalProvider);
    ...
    CMAssociationMIFactory( CmpiLinux_SambaForceGroupForGlobalProvider,
     CmpiLinux_SambaForceGroupForGlobalProvider);
  ...
  CmpiStatus CmpiLinux_SambaForceGroupForGlobalProvider::enumInstanceNames (
  ...
  CmpiStatus CmpiLinux_SambaForceGroupForGlobalProvider::enumInstances (
   const CmpiContext& ctx, CmpiResult& rslt,
  ...
  CmpiStatus CmpiLinux_SambaForceGroupForGlobalProvider::getInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, const char* *properties){
     	
    //covert to instanceName
    Linux_SambaForceGroupForGlobalInstanceName instanceName(cop);
  ...
  CmpiStatus CmpiLinux_SambaForceGroupForGlobalProvider::createInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
...
//      Linux_SambaForceGroupForGlobalRepositoryInstance(inst,shadowNameSpaceP)
//      .getCmpiInstance(0);     
...
//       delete(backupShadowInstance);
  ...
  CmpiStatus CmpiLinux_SambaForceGroupForGlobalProvider::setInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, const CmpiInstance& inst,
  ...
  CmpiStatus CmpiLinux_SambaForceGroupForGlobalProvider::deleteInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop){
      
    Linux_SambaForceGroupForGlobalInstanceName instanceName=
     Linux_SambaForceGroupForGlobalInstanceName(cop);
  ...
  CmpiStatus CmpiLinux_SambaForceGroupForGlobalProvider::invokeMethod (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& ref, const char* methodName,
   const CmpiArgs& in, CmpiArgs& out){
     	
    Linux_SambaForceGroupForGlobalInstanceName instanceName=
     Linux_SambaForceGroupForGlobalInstanceName(ref);
  ...
  CmpiStatus CmpiLinux_SambaForceGroupForGlobalProvider::associationLogic( 
   ...
   const char** properties) {
    ...
    if( references == 0 && instances == 1 ) {
      ...
      while(enumeration.hasNext()) {
        ...
        const Linux_SambaForceGroupForGlobalManualInstance manualInstance =
         enumeration.getNext();
  ...
  CmpiStatus CmpiLinux_SambaForceGroupForGlobalProvider::associators (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, 
   ...
   const char** properties) {
    ...
    cout<<"calling associators() of class Linux_SambaForceGroupForGlobal"<<endl;
  ...
  CmpiStatus CmpiLinux_SambaForceGroupForGlobalProvider::associatorNames (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop,
   const char * assocClass, const char * resultClass,
   const char * role, const char * resultRole) {
   
    cout<<"calling associatorNames() of class Linux_SambaForceGroupForGlobal"<<endl;
  ...
  CmpiStatus CmpiLinux_SambaForceGroupForGlobalProvider::references ( 
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop,
   const char * assocClass, const char * role,
   const char** properties) {
    
    cout<<"calling references() of class Linux_SambaForceGroupForGlobal"<<endl;
  ...
  CmpiStatus CmpiLinux_SambaForceGroupForGlobalProvider::referenceNames (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop,
   const char * assocClass, const char * role) {
   
    cout<<"calling referenceNames() of class Linux_SambaForceGroupForGlobal"<<endl;
