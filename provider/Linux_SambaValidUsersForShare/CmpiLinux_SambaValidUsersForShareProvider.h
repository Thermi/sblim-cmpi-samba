...
#include "CmpiAssociationMI.h"
 ...
 namespace genProvider{
  ...
  class CmpiLinux_SambaValidUsersForShareProvider : public CmpiInstanceMI,
   public CmpiMethodMI, public CmpiAssociationMI{	
	
	private:

	Linux_SambaValidUsersForShareInterface* interfaceP;
	const static char * shadowNameSpaceP;
	CmpiBroker cppBroker;
	    
    void completeInstance (
     const Linux_SambaValidUsersForShareInstanceName& intanceNameP,
    ...
    CmpiInstance* getShadowInstance (
     ...
     const Linux_SambaValidUsersForShareInstanceName& intanceName);
	
    void removeDanglingShadowInstances (
     const Linux_SambaValidUsersForShareInstanceNameEnumeration& dinInsNames);
