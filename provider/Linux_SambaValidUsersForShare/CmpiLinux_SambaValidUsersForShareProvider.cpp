...
namespace genProvider {
  ...
  CmpiLinux_SambaValidUsersForShareProvider::
   ...
   const CmpiBroker &mbp, const CmpiContext& ctx):
    ...
    CmpiMethodMI(mbp,ctx), CmpiAssociationMI(mbp,ctx), cppBroker(mbp) {
      ...
      interfaceP=Linux_SambaValidUsersForShareFactory::getImplementation();           
      cout<<"Provider was constructed"<<endl;
  };
    
        
  const char * CmpiLinux_SambaValidUsersForShareProvider::
  ...
  int CmpiLinux_SambaValidUsersForShareProvider::isUnloadable() const{
    return 0;
  }
  ...
  void CmpiLinux_SambaValidUsersForShareProvider::completeInstance(
   const Linux_SambaValidUsersForShareInstanceName& instanceName,
   CmpiInstance& target, const CmpiContext& ctx){
	  	
    Linux_SambaValidUsersForShareInstanceName shadowInstanceName(instanceName);
  ...
  void CmpiLinux_SambaValidUsersForShareProvider::copyShadowData (
  ...
  CmpiInstance* CmpiLinux_SambaValidUsersForShareProvider::
  ...
  void CmpiLinux_SambaValidUsersForShareProvider::removeDanglingShadowInstances (
  ...
  CMMethodMIFactory(
   CmpiLinux_SambaValidUsersForShareProvider, CmpiLinux_SambaValidUsersForShareProvider);
    ...
    CMAssociationMIFactory( CmpiLinux_SambaValidUsersForShareProvider,
     CmpiLinux_SambaValidUsersForShareProvider);
  ...
  CmpiStatus CmpiLinux_SambaValidUsersForShareProvider::enumInstanceNames (
  ...
  CmpiStatus CmpiLinux_SambaValidUsersForShareProvider::enumInstances (
   const CmpiContext& ctx, CmpiResult& rslt,
  ...
  CmpiStatus CmpiLinux_SambaValidUsersForShareProvider::getInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, const char* *properties){
     	
    //covert to instanceName
    Linux_SambaValidUsersForShareInstanceName instanceName(cop);
  ...
  CmpiStatus CmpiLinux_SambaValidUsersForShareProvider::createInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
...
//      Linux_SambaValidUsersForShareRepositoryInstance(inst,shadowNameSpaceP)
//      .getCmpiInstance(0);     
...
//       delete(backupShadowInstance);
  ...
  CmpiStatus CmpiLinux_SambaValidUsersForShareProvider::setInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, const CmpiInstance& inst,
  ...
  CmpiStatus CmpiLinux_SambaValidUsersForShareProvider::deleteInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop){
      
    Linux_SambaValidUsersForShareInstanceName instanceName=
     Linux_SambaValidUsersForShareInstanceName(cop);
  ...
  CmpiStatus CmpiLinux_SambaValidUsersForShareProvider::invokeMethod (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& ref, const char* methodName,
   const CmpiArgs& in, CmpiArgs& out){
     	
    Linux_SambaValidUsersForShareInstanceName instanceName=
     Linux_SambaValidUsersForShareInstanceName(ref);
  ...
  CmpiStatus CmpiLinux_SambaValidUsersForShareProvider::associationLogic( 
   ...
   const char** properties) {
    ...
    if( references == 0 && instances == 1 ) {
      ...
      while(enumeration.hasNext()) {
        ...
        const Linux_SambaValidUsersForShareManualInstance manualInstance =
         enumeration.getNext();
  ...
  CmpiStatus CmpiLinux_SambaValidUsersForShareProvider::associators (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, 
   ...
   const char** properties) {
    ...
    cout<<"calling associators() of class Linux_SambaValidUsersForShare"<<endl;
  ...
  CmpiStatus CmpiLinux_SambaValidUsersForShareProvider::associatorNames (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop,
   const char * assocClass, const char * resultClass,
   const char * role, const char * resultRole) {
   
    cout<<"calling associatorNames() of class Linux_SambaValidUsersForShare"<<endl;
  ...
  CmpiStatus CmpiLinux_SambaValidUsersForShareProvider::references ( 
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop,
   const char * assocClass, const char * role,
   const char** properties) {
    
    cout<<"calling references() of class Linux_SambaValidUsersForShare"<<endl;
  ...
  CmpiStatus CmpiLinux_SambaValidUsersForShareProvider::referenceNames (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop,
   const char * assocClass, const char * role) {
   
    cout<<"calling referenceNames() of class Linux_SambaValidUsersForShare"<<endl;
