...
namespace genProvider {
  ...
  CmpiLinux_SambaPrinterAdminForGlobalProvider::
   ...
   const CmpiBroker &mbp, const CmpiContext& ctx):
    ...
    CmpiMethodMI(mbp,ctx), CmpiAssociationMI(mbp,ctx), cppBroker(mbp) {
      ...
      interfaceP=Linux_SambaPrinterAdminForGlobalFactory::getImplementation();           
      cout<<"Provider was constructed"<<endl;
  };
    
        
  const char * CmpiLinux_SambaPrinterAdminForGlobalProvider::
  ...
  int CmpiLinux_SambaPrinterAdminForGlobalProvider::isUnloadable() const{
    return 0;
  }
  ...
  void CmpiLinux_SambaPrinterAdminForGlobalProvider::completeInstance(
   const Linux_SambaPrinterAdminForGlobalInstanceName& instanceName,
   CmpiInstance& target, const CmpiContext& ctx){
	  	
    Linux_SambaPrinterAdminForGlobalInstanceName shadowInstanceName(instanceName);
  ...
  void CmpiLinux_SambaPrinterAdminForGlobalProvider::copyShadowData (
  ...
  CmpiInstance* CmpiLinux_SambaPrinterAdminForGlobalProvider::
  ...
  void CmpiLinux_SambaPrinterAdminForGlobalProvider::removeDanglingShadowInstances (
   const Linux_SambaPrinterAdminForGlobalInstanceNameEnumeration& dinInsNames){
  ...
  CMMethodMIFactory(
   CmpiLinux_SambaPrinterAdminForGlobalProvider, CmpiLinux_SambaPrinterAdminForGlobalProvider);
    ...
    CMAssociationMIFactory( CmpiLinux_SambaPrinterAdminForGlobalProvider,
     CmpiLinux_SambaPrinterAdminForGlobalProvider);
  ...
  CmpiStatus CmpiLinux_SambaPrinterAdminForGlobalProvider::enumInstanceNames (
  ...
  CmpiStatus CmpiLinux_SambaPrinterAdminForGlobalProvider::enumInstances (
   const CmpiContext& ctx, CmpiResult& rslt,
  ...
  CmpiStatus CmpiLinux_SambaPrinterAdminForGlobalProvider::getInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, const char* *properties){
     	
    //covert to instanceName
    Linux_SambaPrinterAdminForGlobalInstanceName instanceName(cop);
  ...
  CmpiStatus CmpiLinux_SambaPrinterAdminForGlobalProvider::createInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
...
//      Linux_SambaPrinterAdminForGlobalRepositoryInstance(inst,shadowNameSpaceP)
//      .getCmpiInstance(0);     
...
//       }
  ...
  CmpiStatus CmpiLinux_SambaPrinterAdminForGlobalProvider::setInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, const CmpiInstance& inst,
  ...
  CmpiStatus CmpiLinux_SambaPrinterAdminForGlobalProvider::deleteInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop){
      
    Linux_SambaPrinterAdminForGlobalInstanceName instanceName=
     Linux_SambaPrinterAdminForGlobalInstanceName(cop);
  ...
  CmpiStatus CmpiLinux_SambaPrinterAdminForGlobalProvider::invokeMethod (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& ref, const char* methodName,
   const CmpiArgs& in, CmpiArgs& out){
     	
    Linux_SambaPrinterAdminForGlobalInstanceName instanceName=
     Linux_SambaPrinterAdminForGlobalInstanceName(ref);
  ...
  CmpiStatus CmpiLinux_SambaPrinterAdminForGlobalProvider::associationLogic( 
   ...
   const char** properties) {
    ...
    if( references == 0 && instances == 1 ) {
      ...
      while(enumeration.hasNext()) {
        ...
        const Linux_SambaPrinterAdminForGlobalManualInstance manualInstance =
         enumeration.getNext();
  ...
  CmpiStatus CmpiLinux_SambaPrinterAdminForGlobalProvider::associators (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, 
   ...
   const char** properties) {
    ...
    cout<<"calling associators() of class Linux_SambaPrinterAdminForGlobal"<<endl;
  ...
  CmpiStatus CmpiLinux_SambaPrinterAdminForGlobalProvider::associatorNames (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop,
   const char * assocClass, const char * resultClass,
   const char * role, const char * resultRole) {
   
    cout<<"calling associatorNames() of class Linux_SambaPrinterAdminForGlobal"<<endl;
  ...
  CmpiStatus CmpiLinux_SambaPrinterAdminForGlobalProvider::references ( 
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop,
   const char * assocClass, const char * role,
   const char** properties) {
    
    cout<<"calling references() of class Linux_SambaPrinterAdminForGlobal"<<endl;
  ...
  CmpiStatus CmpiLinux_SambaPrinterAdminForGlobalProvider::referenceNames (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop,
   const char * assocClass, const char * role) {
   
    cout<<"calling referenceNames() of class Linux_SambaPrinterAdminForGlobal"<<endl;
