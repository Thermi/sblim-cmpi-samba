...
namespace genProvider {
  ...
  CmpiLinux_SambaHostProvider::
   ...
   const CmpiBroker &mbp, const CmpiContext& ctx):
    ...
    CmpiMethodMI(mbp,ctx), cppBroker(mbp) {
      ...
      interfaceP=Linux_SambaHostFactory::getImplementation();           
      cout<<"Provider was constructed"<<endl;
  };
    
        
  const char * CmpiLinux_SambaHostProvider::
  ...
  int CmpiLinux_SambaHostProvider::isUnloadable() const{
    return 0;
  }
  ...
  void CmpiLinux_SambaHostProvider::completeInstance(
   const Linux_SambaHostInstanceName& instanceName,
   CmpiInstance& target, const CmpiContext& ctx){
	  	
    Linux_SambaHostInstanceName shadowInstanceName(instanceName);
  ...
  void CmpiLinux_SambaHostProvider::copyShadowData (
  ...
  CmpiInstance* CmpiLinux_SambaHostProvider::
  ...
  void CmpiLinux_SambaHostProvider::removeDanglingShadowInstances (
  ...
  CmpiStatus CmpiLinux_SambaHostProvider::enumInstanceNames (
  ...
  CmpiStatus CmpiLinux_SambaHostProvider::enumInstances (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, const char* *properties){
    ...
    while ( enumeration.hasNext() ){
   	  ...
   	  const Linux_SambaHostManualInstance& instance=
       enumeration.getNext();
  ...
  CmpiStatus CmpiLinux_SambaHostProvider::getInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, const char* *properties){
     	
    //covert to instanceName
    Linux_SambaHostInstanceName instanceName(cop);
  ...
  CmpiStatus CmpiLinux_SambaHostProvider::createInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop,const CmpiInstance& inst){
    ...
    CmpiInstance* backupShadowInstance=0;
     ...
     Linux_SambaHostRepositoryInstance(inst,shadowNameSpaceP)
     .getCmpiInstance(0);     
  ...
  CmpiStatus CmpiLinux_SambaHostProvider::setInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, const CmpiInstance& inst,
  ...
  CmpiStatus CmpiLinux_SambaHostProvider::deleteInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop){
      
    Linux_SambaHostInstanceName instanceName=
     Linux_SambaHostInstanceName(cop);
  ...
  CmpiStatus CmpiLinux_SambaHostProvider::invokeMethod (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& ref, const char* methodName,
   const CmpiArgs& in, CmpiArgs& out){
     	
    Linux_SambaHostInstanceName instanceName=
     Linux_SambaHostInstanceName(ref);
