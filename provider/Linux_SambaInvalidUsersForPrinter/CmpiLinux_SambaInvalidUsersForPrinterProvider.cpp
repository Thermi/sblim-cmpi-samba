...
namespace genProvider {
  ...
  CmpiLinux_SambaInvalidUsersForPrinterProvider::
   ...
   const CmpiBroker &mbp, const CmpiContext& ctx):
    ...
    CmpiMethodMI(mbp,ctx), CmpiAssociationMI(mbp,ctx), cppBroker(mbp) {
      ...
      interfaceP=Linux_SambaInvalidUsersForPrinterFactory::getImplementation();           
      cout<<"Provider was constructed"<<endl;
  };
    
        
  const char * CmpiLinux_SambaInvalidUsersForPrinterProvider::
  ...
  int CmpiLinux_SambaInvalidUsersForPrinterProvider::isUnloadable() const{
    return 0;
  }
  ...
  void CmpiLinux_SambaInvalidUsersForPrinterProvider::completeInstance(
   const Linux_SambaInvalidUsersForPrinterInstanceName& instanceName,
   CmpiInstance& target, const CmpiContext& ctx){
	  	
    Linux_SambaInvalidUsersForPrinterInstanceName shadowInstanceName(instanceName);
  ...
  void CmpiLinux_SambaInvalidUsersForPrinterProvider::copyShadowData (
  ...
  CmpiInstance* CmpiLinux_SambaInvalidUsersForPrinterProvider::
  ...
  void CmpiLinux_SambaInvalidUsersForPrinterProvider::removeDanglingShadowInstances (
   const Linux_SambaInvalidUsersForPrinterInstanceNameEnumeration& dinInsNames){
  ...
  CMMethodMIFactory(
   CmpiLinux_SambaInvalidUsersForPrinterProvider, CmpiLinux_SambaInvalidUsersForPrinterProvider);
    ...
    CMAssociationMIFactory( CmpiLinux_SambaInvalidUsersForPrinterProvider,
     CmpiLinux_SambaInvalidUsersForPrinterProvider);
  ...
  CmpiStatus CmpiLinux_SambaInvalidUsersForPrinterProvider::enumInstanceNames (
  ...
  CmpiStatus CmpiLinux_SambaInvalidUsersForPrinterProvider::enumInstances (
   const CmpiContext& ctx, CmpiResult& rslt,
  ...
  CmpiStatus CmpiLinux_SambaInvalidUsersForPrinterProvider::getInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, const char* *properties){
     	
    //covert to instanceName
    Linux_SambaInvalidUsersForPrinterInstanceName instanceName(cop);
  ...
  CmpiStatus CmpiLinux_SambaInvalidUsersForPrinterProvider::createInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
...
//      Linux_SambaInvalidUsersForPrinterRepositoryInstance(inst,shadowNameSpaceP)
//      .getCmpiInstance(0);     
...
//       delete(backupShadowInstance);
  ...
  CmpiStatus CmpiLinux_SambaInvalidUsersForPrinterProvider::setInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, const CmpiInstance& inst,
  ...
  CmpiStatus CmpiLinux_SambaInvalidUsersForPrinterProvider::deleteInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop){
      
    Linux_SambaInvalidUsersForPrinterInstanceName instanceName=
     Linux_SambaInvalidUsersForPrinterInstanceName(cop);
  ...
  CmpiStatus CmpiLinux_SambaInvalidUsersForPrinterProvider::invokeMethod (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& ref, const char* methodName,
   const CmpiArgs& in, CmpiArgs& out){
     	
    Linux_SambaInvalidUsersForPrinterInstanceName instanceName=
     Linux_SambaInvalidUsersForPrinterInstanceName(ref);
  ...
  CmpiStatus CmpiLinux_SambaInvalidUsersForPrinterProvider::associationLogic( 
   ...
   const char** properties) {
    ...
    if( references == 0 && instances == 1 ) {
      ...
      while(enumeration.hasNext()) {
        ...
        const Linux_SambaInvalidUsersForPrinterManualInstance manualInstance =
         enumeration.getNext();
  ...
  CmpiStatus CmpiLinux_SambaInvalidUsersForPrinterProvider::associators (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, 
   ...
   const char** properties) {
    ...
    cout<<"calling associators() of class Linux_SambaInvalidUsersForPrinter"<<endl;
  ...
  CmpiStatus CmpiLinux_SambaInvalidUsersForPrinterProvider::associatorNames (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop,
   const char * assocClass, const char * resultClass,
   const char * role, const char * resultRole) {
   
    cout<<"calling associatorNames() of class Linux_SambaInvalidUsersForPrinter"<<endl;
  ...
  CmpiStatus CmpiLinux_SambaInvalidUsersForPrinterProvider::references ( 
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop,
   const char * assocClass, const char * role,
   const char** properties) {
    
    cout<<"calling references() of class Linux_SambaInvalidUsersForPrinter"<<endl;
  ...
  CmpiStatus CmpiLinux_SambaInvalidUsersForPrinterProvider::referenceNames (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop,
   const char * assocClass, const char * role) {
   
    cout<<"calling referenceNames() of class Linux_SambaInvalidUsersForPrinter"<<endl;
