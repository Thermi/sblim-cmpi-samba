...
namespace genProvider {
  ...
  class Linux_SambaGlobalFileNameHandlingOptionsInterface {
    ...
    virtual void enumInstanceNames(
     ...
     const char *nsp,
     Linux_SambaGlobalFileNameHandlingOptionsInstanceNameEnumeration& instnames) = 0;
    ...
    virtual void enumInstances(
     ...
     const char* *properties,
  	 Linux_SambaGlobalFileNameHandlingOptionsManualInstanceEnumeration& instances) = 0;
  	
    virtual Linux_SambaGlobalFileNameHandlingOptionsManualInstance getInstance(
     const CmpiContext& ctx,
     const CmpiBroker &mbp,
     const char* *properties,
     const Linux_SambaGlobalFileNameHandlingOptionsInstanceName&) = 0;
  	
    virtual void setInstance(
     const CmpiContext& ctx,
     const CmpiBroker &mbp,
     const char* *properties,
     const Linux_SambaGlobalFileNameHandlingOptionsManualInstance&) = 0;
