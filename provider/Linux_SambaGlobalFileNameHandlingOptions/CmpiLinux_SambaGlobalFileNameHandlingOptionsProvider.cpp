...
namespace genProvider {
  ...
  CmpiLinux_SambaGlobalFileNameHandlingOptionsProvider::
   ...
   const CmpiBroker &mbp, const CmpiContext& ctx):
    ...
    CmpiMethodMI(mbp,ctx), cppBroker(mbp) {
      ...
      interfaceP=Linux_SambaGlobalFileNameHandlingOptionsFactory::getImplementation();           
      cout<<"Provider was constructed"<<endl;
  };
    
        
  const char * CmpiLinux_SambaGlobalFileNameHandlingOptionsProvider::
  ...
  int CmpiLinux_SambaGlobalFileNameHandlingOptionsProvider::isUnloadable() const{
    return 0;
  }
  ...
  void CmpiLinux_SambaGlobalFileNameHandlingOptionsProvider::completeInstance(
   const Linux_SambaGlobalFileNameHandlingOptionsInstanceName& instanceName,
   CmpiInstance& target, const CmpiContext& ctx){
	  	
    Linux_SambaGlobalFileNameHandlingOptionsInstanceName shadowInstanceName(instanceName);
  ...
  void CmpiLinux_SambaGlobalFileNameHandlingOptionsProvider::copyShadowData (
  ...
  CmpiInstance* CmpiLinux_SambaGlobalFileNameHandlingOptionsProvider::
  ...
  void CmpiLinux_SambaGlobalFileNameHandlingOptionsProvider::removeDanglingShadowInstances (
  ...
  CmpiStatus CmpiLinux_SambaGlobalFileNameHandlingOptionsProvider::enumInstanceNames (
  ...
  CmpiStatus CmpiLinux_SambaGlobalFileNameHandlingOptionsProvider::enumInstances (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, const char* *properties){
    ...
    while ( enumeration.hasNext() ){
   	  ...
   	  const Linux_SambaGlobalFileNameHandlingOptionsManualInstance& instance=
       enumeration.getNext();
  ...
  CmpiStatus CmpiLinux_SambaGlobalFileNameHandlingOptionsProvider::getInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, const char* *properties){
     	
    //covert to instanceName
    Linux_SambaGlobalFileNameHandlingOptionsInstanceName instanceName(cop);
  ...
  CmpiStatus CmpiLinux_SambaGlobalFileNameHandlingOptionsProvider::createInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
...
//      Linux_SambaGlobalFileNameHandlingOptionsRepositoryInstance(inst,shadowNameSpaceP)
//      .getCmpiInstance(0);     
...
//       delete(backupShadowInstance);
  ...
  CmpiStatus CmpiLinux_SambaGlobalFileNameHandlingOptionsProvider::setInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, const CmpiInstance& inst,
...
//       delete(backupShadowInstance);
  ...
  CmpiStatus CmpiLinux_SambaGlobalFileNameHandlingOptionsProvider::deleteInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop){
      
    Linux_SambaGlobalFileNameHandlingOptionsInstanceName instanceName=
     Linux_SambaGlobalFileNameHandlingOptionsInstanceName(cop);
  ...
  CmpiStatus CmpiLinux_SambaGlobalFileNameHandlingOptionsProvider::invokeMethod (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& ref, const char* methodName,
   const CmpiArgs& in, CmpiArgs& out){
     	
    Linux_SambaGlobalFileNameHandlingOptionsInstanceName instanceName=
     Linux_SambaGlobalFileNameHandlingOptionsInstanceName(ref);
