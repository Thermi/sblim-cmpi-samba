...
namespace genProvider {
  ...
  CmpiLinux_SambaGroupProvider::
   ...
   const CmpiBroker &mbp, const CmpiContext& ctx):
    ...
    CmpiMethodMI(mbp,ctx), cppBroker(mbp) {
      ...
      interfaceP=Linux_SambaGroupFactory::getImplementation();           
      cout<<"Provider was constructed"<<endl;
  };
    
        
  const char * CmpiLinux_SambaGroupProvider::
  ...
  int CmpiLinux_SambaGroupProvider::isUnloadable() const{
    return 0;
  }
  ...
  void CmpiLinux_SambaGroupProvider::completeInstance(
   const Linux_SambaGroupInstanceName& instanceName,
   CmpiInstance& target, const CmpiContext& ctx){
	  	
    Linux_SambaGroupInstanceName shadowInstanceName(instanceName);
  ...
  void CmpiLinux_SambaGroupProvider::copyShadowData (
  ...
  CmpiInstance* CmpiLinux_SambaGroupProvider::
  ...
  void CmpiLinux_SambaGroupProvider::removeDanglingShadowInstances (
  ...
  CmpiStatus CmpiLinux_SambaGroupProvider::enumInstanceNames (
  ...
  CmpiStatus CmpiLinux_SambaGroupProvider::enumInstances (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, const char* *properties){
    ...
    while ( enumeration.hasNext() ){
   	  ...
   	  const Linux_SambaGroupManualInstance& instance=
       enumeration.getNext();
  ...
  CmpiStatus CmpiLinux_SambaGroupProvider::getInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, const char* *properties){
     	
    //covert to instanceName
    Linux_SambaGroupInstanceName instanceName(cop);
  ...
  CmpiStatus CmpiLinux_SambaGroupProvider::createInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
...
//      Linux_SambaGroupRepositoryInstance(inst,shadowNameSpaceP)
//      .getCmpiInstance(0);     
...
//       delete(backupShadowInstance);
  ...
  CmpiStatus CmpiLinux_SambaGroupProvider::setInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, const CmpiInstance& inst,
...
//       delete(backupShadowInstance);
  ...
  CmpiStatus CmpiLinux_SambaGroupProvider::deleteInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop){
      
    Linux_SambaGroupInstanceName instanceName=
     Linux_SambaGroupInstanceName(cop);
  ...
  CmpiStatus CmpiLinux_SambaGroupProvider::invokeMethod (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& ref, const char* methodName,
   const CmpiArgs& in, CmpiArgs& out){
     	
    Linux_SambaGroupInstanceName instanceName=
     Linux_SambaGroupInstanceName(ref);
