...
#include "Linux_SambaGroupFactory.h"
 ...
 namespace genProvider{
  ...
  class CmpiLinux_SambaGroupProvider : public CmpiInstanceMI,
   public CmpiMethodMI{	
	
	private:

	Linux_SambaGroupInterface* interfaceP;
	const static char * shadowNameSpaceP;
	CmpiBroker cppBroker;
	    
    void completeInstance (
     const Linux_SambaGroupInstanceName& intanceNameP,
    ...
    CmpiInstance* getShadowInstance (
     ...
     const Linux_SambaGroupInstanceName& intanceName);
	
    void removeDanglingShadowInstances (
     const Linux_SambaGroupInstanceNameEnumeration& dinInsNames);
