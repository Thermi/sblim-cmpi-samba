...
namespace genProvider{
  ...
  class CmpiLinux_SambaSharePrinterBrowseForShareProvider : 
    public CmpiInstanceMI,
    public CmpiMethodMI, public CmpiAssociationMI {	
	
	  private:
	  Linux_SambaSharePrinterBrowseForShareInterface* m_interfaceP;
	  CmpiBroker m_cmpiBroker;
	    
	  private:

    void completeInstance(
      const Linux_SambaSharePrinterBrowseForShareInstanceName& anInstanceNameP,
