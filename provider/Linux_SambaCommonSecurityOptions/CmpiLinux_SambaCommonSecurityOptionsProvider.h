...
#include "Linux_SambaCommonSecurityOptionsFactory.h"
 ...
 namespace genProvider{
  ...
  class CmpiLinux_SambaCommonSecurityOptionsProvider : public CmpiInstanceMI,
   public CmpiMethodMI{	
	
	private:

	Linux_SambaCommonSecurityOptionsInterface* interfaceP;
	const static char * shadowNameSpaceP;
	CmpiBroker cppBroker;
	    
    void completeInstance (
     const Linux_SambaCommonSecurityOptionsInstanceName& intanceNameP,
    ...
    CmpiInstance* getShadowInstance (
     ...
     const Linux_SambaCommonSecurityOptionsInstanceName& intanceName);
