...
namespace genProvider {
  ...
  class Linux_SambaPrinterSecurityForGlobalInterface {
    ...
    virtual void enumInstanceNames(
     ...
     const char *nsp,
     Linux_SambaPrinterSecurityForGlobalInstanceNameEnumeration& instnames) = 0;
    ...
    virtual void enumInstances(
     ...
     const char* *properties,
  	 Linux_SambaPrinterSecurityForGlobalManualInstanceEnumeration& instances) = 0;
  	
    virtual Linux_SambaPrinterSecurityForGlobalManualInstance getInstance(
     const CmpiContext& ctx,
     const CmpiBroker &mbp,
     const char* *properties,
     const Linux_SambaPrinterSecurityForGlobalInstanceName&) = 0;
  	
    virtual void setInstance(
     const CmpiContext& ctx,
     const CmpiBroker &mbp,
     const char* *properties,
     const Linux_SambaPrinterSecurityForGlobalManualInstance&) = 0;
