...
namespace genProvider {
  ...
  CmpiLinux_SambaShareProtocolForShareProvider::
   ...
   const CmpiBroker &mbp, const CmpiContext& ctx):
    ...
    CmpiMethodMI(mbp,ctx), CmpiAssociationMI(mbp,ctx), cppBroker(mbp) {
      ...
      interfaceP=Linux_SambaShareProtocolForShareFactory::getImplementation();           
      cout<<"Provider was constructed"<<endl;
  };
    
        
  const char * CmpiLinux_SambaShareProtocolForShareProvider::
  ...
  int CmpiLinux_SambaShareProtocolForShareProvider::isUnloadable() const{
    return 0;
  }
  ...
  void CmpiLinux_SambaShareProtocolForShareProvider::completeInstance(
   const Linux_SambaShareProtocolForShareInstanceName& instanceName,
   CmpiInstance& target, const CmpiContext& ctx){
	  	
    Linux_SambaShareProtocolForShareInstanceName shadowInstanceName(instanceName);
  ...
  void CmpiLinux_SambaShareProtocolForShareProvider::copyShadowData (
  ...
  CmpiInstance* CmpiLinux_SambaShareProtocolForShareProvider::
  ...
  void CmpiLinux_SambaShareProtocolForShareProvider::removeDanglingShadowInstances (
   const Linux_SambaShareProtocolForShareInstanceNameEnumeration& dinInsNames){
  ...
  CMMethodMIFactory(
   CmpiLinux_SambaShareProtocolForShareProvider, CmpiLinux_SambaShareProtocolForShareProvider);
    ...
    CMAssociationMIFactory( CmpiLinux_SambaShareProtocolForShareProvider,
     CmpiLinux_SambaShareProtocolForShareProvider);
  ...
  CmpiStatus CmpiLinux_SambaShareProtocolForShareProvider::enumInstanceNames (
  ...
  CmpiStatus CmpiLinux_SambaShareProtocolForShareProvider::enumInstances (
   const CmpiContext& ctx, CmpiResult& rslt,
  ...
  CmpiStatus CmpiLinux_SambaShareProtocolForShareProvider::getInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, const char* *properties){
     	
    //covert to instanceName
    Linux_SambaShareProtocolForShareInstanceName instanceName(cop);
  ...
  CmpiStatus CmpiLinux_SambaShareProtocolForShareProvider::createInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop,const CmpiInstance& inst){
    ...
    CmpiInstance* backupShadowInstance=0;
     ...
     Linux_SambaShareProtocolForShareRepositoryInstance(inst,shadowNameSpaceP)
     .getCmpiInstance(0);     
  ...
  CmpiStatus CmpiLinux_SambaShareProtocolForShareProvider::setInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, const CmpiInstance& inst,
  ...
  CmpiStatus CmpiLinux_SambaShareProtocolForShareProvider::deleteInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop){
      
    Linux_SambaShareProtocolForShareInstanceName instanceName=
     Linux_SambaShareProtocolForShareInstanceName(cop);
  ...
  CmpiStatus CmpiLinux_SambaShareProtocolForShareProvider::invokeMethod (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& ref, const char* methodName,
   const CmpiArgs& in, CmpiArgs& out){
     	
    Linux_SambaShareProtocolForShareInstanceName instanceName=
     Linux_SambaShareProtocolForShareInstanceName(ref);
  ...
  CmpiStatus CmpiLinux_SambaShareProtocolForShareProvider::associationLogic( 
   ...
   const char** properties) {
    ...
    if( references == 0 && instances == 1 ) {
      ...
      else if(cop.classPathIsA("Linux_SambaShareProtocolOptions")) {
        Linux_SambaShareOptionsInstanceEnumeration enumeration;
        Linux_SambaShareProtocolOptionsInstanceName SettingData(cop);
      ...
      if(cop.classPathIsA("Linux_SambaShareProtocolOptions")) {
        Linux_SambaShareProtocolOptionsInstanceName SettingData(cop);
      ...
      while(enumeration.hasNext()) {
        ...
        const Linux_SambaShareProtocolForShareManualInstance manualInstance =
         enumeration.getNext();
  ...
  CmpiStatus CmpiLinux_SambaShareProtocolForShareProvider::associators (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, 
   ...
   const char** properties) {
    ...
    cout<<"calling associators() of class Linux_SambaShareProtocolForShare"<<endl;
  ...
  CmpiStatus CmpiLinux_SambaShareProtocolForShareProvider::associatorNames (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop,
   const char * assocClass, const char * resultClass,
   const char * role, const char * resultRole) {
   
    cout<<"calling associatorNames() of class Linux_SambaShareProtocolForShare"<<endl;
  ...
  CmpiStatus CmpiLinux_SambaShareProtocolForShareProvider::references ( 
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop,
   const char * assocClass, const char * role,
   const char** properties) {
    
    cout<<"calling references() of class Linux_SambaShareProtocolForShare"<<endl;
  ...
  CmpiStatus CmpiLinux_SambaShareProtocolForShareProvider::referenceNames (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop,
   const char * assocClass, const char * role) {
   
    cout<<"calling referenceNames() of class Linux_SambaShareProtocolForShare"<<endl;
