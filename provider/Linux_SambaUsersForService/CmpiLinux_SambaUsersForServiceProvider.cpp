...
namespace genProvider {
  ...
  CmpiLinux_SambaUsersForServiceProvider::
   ...
   const CmpiBroker &mbp, const CmpiContext& ctx):
    ...
    CmpiMethodMI(mbp,ctx), CmpiAssociationMI(mbp,ctx), cppBroker(mbp) {
      ...
      interfaceP=Linux_SambaUsersForServiceFactory::getImplementation();           
      cout<<"Provider was constructed"<<endl;
  };
    
        
  const char * CmpiLinux_SambaUsersForServiceProvider::
  ...
  int CmpiLinux_SambaUsersForServiceProvider::isUnloadable() const{
    return 0;
  }
  ...
  void CmpiLinux_SambaUsersForServiceProvider::completeInstance(
   const Linux_SambaUsersForServiceInstanceName& instanceName,
   CmpiInstance& target, const CmpiContext& ctx){
	  	
    Linux_SambaUsersForServiceInstanceName shadowInstanceName(instanceName);
  ...
  void CmpiLinux_SambaUsersForServiceProvider::copyShadowData (
  ...
  CmpiInstance* CmpiLinux_SambaUsersForServiceProvider::
  ...
  void CmpiLinux_SambaUsersForServiceProvider::removeDanglingShadowInstances (
   const Linux_SambaUsersForServiceInstanceNameEnumeration& dinInsNames){
  ...
  CMMethodMIFactory(
   CmpiLinux_SambaUsersForServiceProvider, CmpiLinux_SambaUsersForServiceProvider);
    ...
    CMAssociationMIFactory( CmpiLinux_SambaUsersForServiceProvider,
     CmpiLinux_SambaUsersForServiceProvider);
  ...
  CmpiStatus CmpiLinux_SambaUsersForServiceProvider::enumInstanceNames (
  ...
  CmpiStatus CmpiLinux_SambaUsersForServiceProvider::enumInstances (
   const CmpiContext& ctx, CmpiResult& rslt,
  ...
  CmpiStatus CmpiLinux_SambaUsersForServiceProvider::getInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, const char* *properties){
     	
    //covert to instanceName
    Linux_SambaUsersForServiceInstanceName instanceName(cop);
  ...
  CmpiStatus CmpiLinux_SambaUsersForServiceProvider::createInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
...
//      Linux_SambaUsersForServiceRepositoryInstance(inst,shadowNameSpaceP)
//      .getCmpiInstance(0);     
...
//       delete(backupShadowInstance);
  ...
  CmpiStatus CmpiLinux_SambaUsersForServiceProvider::setInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, const CmpiInstance& inst,
  ...
  CmpiStatus CmpiLinux_SambaUsersForServiceProvider::deleteInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop){
      
    Linux_SambaUsersForServiceInstanceName instanceName=
     Linux_SambaUsersForServiceInstanceName(cop);
  ...
  CmpiStatus CmpiLinux_SambaUsersForServiceProvider::invokeMethod (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& ref, const char* methodName,
   const CmpiArgs& in, CmpiArgs& out){
     	
    Linux_SambaUsersForServiceInstanceName instanceName=
     Linux_SambaUsersForServiceInstanceName(ref);
  ...
  CmpiStatus CmpiLinux_SambaUsersForServiceProvider::associationLogic( 
   ...
   const char** properties) {
    ...
    if( references == 0 && instances == 1 ) {
      ...
      if(cop.classPathIsA("Linux_SambaUser")) {
        ...
        Linux_SambaServiceInstanceName GroupComponent(cop);
      ...
      while(enumeration.hasNext()) {
        ...
        const Linux_SambaUsersForServiceManualInstance manualInstance =
         enumeration.getNext();
  ...
  CmpiStatus CmpiLinux_SambaUsersForServiceProvider::associators (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, 
   ...
   const char** properties) {
    ...
    cout<<"calling associators() of class Linux_SambaUsersForService"<<endl;
  ...
  CmpiStatus CmpiLinux_SambaUsersForServiceProvider::associatorNames (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop,
   const char * assocClass, const char * resultClass,
   const char * role, const char * resultRole) {
   
    cout<<"calling associatorNames() of class Linux_SambaUsersForService"<<endl;
  ...
  CmpiStatus CmpiLinux_SambaUsersForServiceProvider::references ( 
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop,
   const char * assocClass, const char * role,
   const char** properties) {
    
    cout<<"calling references() of class Linux_SambaUsersForService"<<endl;
  ...
  CmpiStatus CmpiLinux_SambaUsersForServiceProvider::referenceNames (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop,
   const char * assocClass, const char * role) {
   
    cout<<"calling referenceNames() of class Linux_SambaUsersForService"<<endl;
