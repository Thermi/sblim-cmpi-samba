...
namespace genProvider {
  ...
  CmpiLinux_SambaGlobalSecurityForGlobalProvider::
   ...
   const CmpiBroker &mbp, const CmpiContext& ctx):
    ...
    CmpiMethodMI(mbp,ctx), CmpiAssociationMI(mbp,ctx), cppBroker(mbp) {
      ...
      interfaceP=Linux_SambaGlobalSecurityForGlobalFactory::getImplementation();           
      cout<<"Provider was constructed"<<endl;
  };
    
        
  const char * CmpiLinux_SambaGlobalSecurityForGlobalProvider::
  ...
  int CmpiLinux_SambaGlobalSecurityForGlobalProvider::isUnloadable() const{
    return 0;
  }
  ...
  void CmpiLinux_SambaGlobalSecurityForGlobalProvider::completeInstance(
   const Linux_SambaGlobalSecurityForGlobalInstanceName& instanceName,
   CmpiInstance& target, const CmpiContext& ctx){
	  	
    Linux_SambaGlobalSecurityForGlobalInstanceName shadowInstanceName(instanceName);
  ...
  void CmpiLinux_SambaGlobalSecurityForGlobalProvider::copyShadowData (
  ...
  CmpiInstance* CmpiLinux_SambaGlobalSecurityForGlobalProvider::
  ...
  void CmpiLinux_SambaGlobalSecurityForGlobalProvider::removeDanglingShadowInstances (
  ...
  CMMethodMIFactory(
   CmpiLinux_SambaGlobalSecurityForGlobalProvider, CmpiLinux_SambaGlobalSecurityForGlobalProvider);
    ...
    CMAssociationMIFactory( CmpiLinux_SambaGlobalSecurityForGlobalProvider,
     CmpiLinux_SambaGlobalSecurityForGlobalProvider);
  ...
  CmpiStatus CmpiLinux_SambaGlobalSecurityForGlobalProvider::enumInstanceNames (
  ...
  CmpiStatus CmpiLinux_SambaGlobalSecurityForGlobalProvider::enumInstances (
   const CmpiContext& ctx, CmpiResult& rslt,
  ...
  CmpiStatus CmpiLinux_SambaGlobalSecurityForGlobalProvider::getInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, const char* *properties){
     	
    //covert to instanceName
    Linux_SambaGlobalSecurityForGlobalInstanceName instanceName(cop);
  ...
  CmpiStatus CmpiLinux_SambaGlobalSecurityForGlobalProvider::createInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop,const CmpiInstance& inst){
    ...
    CmpiInstance* backupShadowInstance=0;
     ...
     Linux_SambaGlobalSecurityForGlobalRepositoryInstance(inst,shadowNameSpaceP)
     .getCmpiInstance(0);     
  ...
  CmpiStatus CmpiLinux_SambaGlobalSecurityForGlobalProvider::setInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, const CmpiInstance& inst,
  ...
  CmpiStatus CmpiLinux_SambaGlobalSecurityForGlobalProvider::deleteInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop){
      
    Linux_SambaGlobalSecurityForGlobalInstanceName instanceName=
     Linux_SambaGlobalSecurityForGlobalInstanceName(cop);
  ...
  CmpiStatus CmpiLinux_SambaGlobalSecurityForGlobalProvider::invokeMethod (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& ref, const char* methodName,
   const CmpiArgs& in, CmpiArgs& out){
     	
    Linux_SambaGlobalSecurityForGlobalInstanceName instanceName=
     Linux_SambaGlobalSecurityForGlobalInstanceName(ref);
  ...
  CmpiStatus CmpiLinux_SambaGlobalSecurityForGlobalProvider::associationLogic( 
   ...
   const char** properties) {
    ...
    if( references == 0 && instances == 1 ) {
      ...
      if(cop.classPathIsA("Linux_SambaGlobalSecurityOptions")) {
        Linux_SambaGlobalOptionsInstanceEnumeration enumeration;
        Linux_SambaGlobalSecurityOptionsInstanceName SettingData(cop);
      ...
      while(enumeration.hasNext()) {
        ...
        const Linux_SambaGlobalSecurityForGlobalManualInstance manualInstance =
         enumeration.getNext();
  ...
  CmpiStatus CmpiLinux_SambaGlobalSecurityForGlobalProvider::associators (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, 
   ...
   const char** properties) {
    ...
    cout<<"calling associators() of class Linux_SambaGlobalSecurityForGlobal"<<endl;
  ...
  CmpiStatus CmpiLinux_SambaGlobalSecurityForGlobalProvider::associatorNames (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop,
   const char * assocClass, const char * resultClass,
   const char * role, const char * resultRole) {
   
    cout<<"calling associatorNames() of class Linux_SambaGlobalSecurityForGlobal"<<endl;
  ...
  CmpiStatus CmpiLinux_SambaGlobalSecurityForGlobalProvider::references ( 
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop,
   const char * assocClass, const char * role,
   const char** properties) {
    
    cout<<"calling references() of class Linux_SambaGlobalSecurityForGlobal"<<endl;
  ...
  CmpiStatus CmpiLinux_SambaGlobalSecurityForGlobalProvider::referenceNames (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop,
   const char * assocClass, const char * role) {
   
    cout<<"calling referenceNames() of class Linux_SambaGlobalSecurityForGlobal"<<endl;
