...
#include "CmpiAssociationMI.h"
 ...
 namespace genProvider{
  ...
  class CmpiLinux_SambaGlobalSecurityForGlobalProvider : public CmpiInstanceMI,
   public CmpiMethodMI, public CmpiAssociationMI{	
	
	private:

	Linux_SambaGlobalSecurityForGlobalInterface* interfaceP;
	const static char * shadowNameSpaceP;
	CmpiBroker cppBroker;
	    
    void completeInstance (
     const Linux_SambaGlobalSecurityForGlobalInstanceName& intanceNameP,
    ...
    CmpiInstance* getShadowInstance (
     ...
     const Linux_SambaGlobalSecurityForGlobalInstanceName& intanceName);
	
    void removeDanglingShadowInstances (
     const Linux_SambaGlobalSecurityForGlobalInstanceNameEnumeration& dinInsNames);
