...
namespace genProvider {
  ...
  CmpiLinux_SambaServiceConfigurationProvider::
   ...
   const CmpiBroker &mbp, const CmpiContext& ctx):
    ...
    CmpiMethodMI(mbp,ctx), cppBroker(mbp) {
      ...
      interfaceP=Linux_SambaServiceConfigurationFactory::getImplementation();           
      cout<<"Provider was constructed"<<endl;
  };
    
        
  const char * CmpiLinux_SambaServiceConfigurationProvider::
  ...
  int CmpiLinux_SambaServiceConfigurationProvider::isUnloadable() const{
    return 0;
  }
  ...
  void CmpiLinux_SambaServiceConfigurationProvider::completeInstance(
   const Linux_SambaServiceConfigurationInstanceName& instanceName,
   CmpiInstance& target, const CmpiContext& ctx){
	  	
    Linux_SambaServiceConfigurationInstanceName shadowInstanceName(instanceName);
  ...
  void CmpiLinux_SambaServiceConfigurationProvider::copyShadowData (
  ...
  CmpiInstance* CmpiLinux_SambaServiceConfigurationProvider::
  ...
  void CmpiLinux_SambaServiceConfigurationProvider::removeDanglingShadowInstances (
  ...
  CmpiStatus CmpiLinux_SambaServiceConfigurationProvider::enumInstanceNames (
  ...
  CmpiStatus CmpiLinux_SambaServiceConfigurationProvider::enumInstances (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, const char* *properties){
    ...
    while ( enumeration.hasNext() ){
   	  ...
   	  const Linux_SambaServiceConfigurationManualInstance& instance=
       enumeration.getNext();
  ...
  CmpiStatus CmpiLinux_SambaServiceConfigurationProvider::getInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, const char* *properties){
     	
    //covert to instanceName
    Linux_SambaServiceConfigurationInstanceName instanceName(cop);
  ...
  CmpiStatus CmpiLinux_SambaServiceConfigurationProvider::createInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
...
//      Linux_SambaServiceConfigurationRepositoryInstance(inst,shadowNameSpaceP)
//      .getCmpiInstance(0);     
...
//       delete(backupShadowInstance);
  ...
  CmpiStatus CmpiLinux_SambaServiceConfigurationProvider::setInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, const CmpiInstance& inst,
...
//       delete(backupShadowInstance);
  ...
  CmpiStatus CmpiLinux_SambaServiceConfigurationProvider::deleteInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop){
      
    Linux_SambaServiceConfigurationInstanceName instanceName=
     Linux_SambaServiceConfigurationInstanceName(cop);
  ...
  CmpiStatus CmpiLinux_SambaServiceConfigurationProvider::invokeMethod (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& ref, const char* methodName,
   const CmpiArgs& in, CmpiArgs& out){
     	
    Linux_SambaServiceConfigurationInstanceName instanceName=
     Linux_SambaServiceConfigurationInstanceName(ref);
