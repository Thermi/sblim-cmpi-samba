...
#include "Linux_SambaServiceFactory.h"
 ...
 namespace genProvider{
  ...
  class CmpiLinux_SambaServiceProvider : public CmpiInstanceMI,
   public CmpiMethodMI{	
	
	private:

	Linux_SambaServiceInterface* interfaceP;
	const static char * shadowNameSpaceP;
	CmpiBroker cppBroker;
	    
    void completeInstance (
     const Linux_SambaServiceInstanceName& intanceNameP,
    ...
    CmpiInstance* getShadowInstance (
     ...
     const Linux_SambaServiceInstanceName& intanceName);
