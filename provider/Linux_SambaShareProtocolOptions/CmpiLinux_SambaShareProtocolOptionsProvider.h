...
#include "Linux_SambaShareProtocolOptionsFactory.h"
 ...
 namespace genProvider{
  ...
  class CmpiLinux_SambaShareProtocolOptionsProvider : public CmpiInstanceMI,
   public CmpiMethodMI{	
	
	private:

	Linux_SambaShareProtocolOptionsInterface* interfaceP;
	const static char * shadowNameSpaceP;
	CmpiBroker cppBroker;
	    
    void completeInstance (
     const Linux_SambaShareProtocolOptionsInstanceName& intanceNameP,
    ...
    CmpiInstance* getShadowInstance (
     ...
     const Linux_SambaShareProtocolOptionsInstanceName& intanceName);
	
    void removeDanglingShadowInstances (
     const Linux_SambaShareProtocolOptionsInstanceNameEnumeration& dinInsNames);
