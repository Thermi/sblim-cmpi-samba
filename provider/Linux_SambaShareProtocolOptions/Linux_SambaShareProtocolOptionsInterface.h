...
namespace genProvider {
  ...
  class Linux_SambaShareProtocolOptionsInterface {
    ...
    virtual void enumInstanceNames(
     ...
     const char *nsp,
     Linux_SambaShareProtocolOptionsInstanceNameEnumeration& instnames) = 0;
    ...
    virtual void enumInstances(
     ...
     const char* *properties,
  	 Linux_SambaShareProtocolOptionsManualInstanceEnumeration& instances) = 0;
  	
    virtual Linux_SambaShareProtocolOptionsManualInstance getInstance(
     const CmpiContext& ctx,
     const CmpiBroker &mbp,
     const char* *properties,
     const Linux_SambaShareProtocolOptionsInstanceName&) = 0;
  	
    virtual void setInstance(
     const CmpiContext& ctx,
     const CmpiBroker &mbp,
     const char* *properties,
     const Linux_SambaShareProtocolOptionsManualInstance&) = 0;
