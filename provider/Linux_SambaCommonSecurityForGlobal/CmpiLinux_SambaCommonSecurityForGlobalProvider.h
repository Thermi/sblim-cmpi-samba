...
#include "CmpiAssociationMI.h"
 ...
 namespace genProvider{
  ...
  class CmpiLinux_SambaCommonSecurityForGlobalProvider : public CmpiInstanceMI,
   public CmpiMethodMI, public CmpiAssociationMI{	
	
	private:

	Linux_SambaCommonSecurityForGlobalInterface* interfaceP;
	const static char * shadowNameSpaceP;
	CmpiBroker cppBroker;
	    
    void completeInstance (
     const Linux_SambaCommonSecurityForGlobalInstanceName& intanceNameP,
    ...
    CmpiInstance* getShadowInstance (
     ...
     const Linux_SambaCommonSecurityForGlobalInstanceName& intanceName);
	
    void removeDanglingShadowInstances (
     const Linux_SambaCommonSecurityForGlobalInstanceNameEnumeration& dinInsNames);
