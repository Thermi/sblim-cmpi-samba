...
namespace genProvider {
  ...
  CmpiLinux_SambaPrinterOptionsProvider::
   ...
   const CmpiBroker &mbp, const CmpiContext& ctx):
    ...
    CmpiMethodMI(mbp,ctx), cppBroker(mbp) {
      ...
      interfaceP=Linux_SambaPrinterOptionsFactory::getImplementation();           
      cout<<"Provider was constructed"<<endl;
  };
    
        
  const char * CmpiLinux_SambaPrinterOptionsProvider::
  ...
  int CmpiLinux_SambaPrinterOptionsProvider::isUnloadable() const{
    return 0;
  }
  ...
  void CmpiLinux_SambaPrinterOptionsProvider::completeInstance(
   const Linux_SambaPrinterOptionsInstanceName& instanceName,
   CmpiInstance& target, const CmpiContext& ctx){
	  	
    Linux_SambaPrinterOptionsInstanceName shadowInstanceName(instanceName);
  ...
  void CmpiLinux_SambaPrinterOptionsProvider::copyShadowData (
  ...
  CmpiInstance* CmpiLinux_SambaPrinterOptionsProvider::
  ...
  void CmpiLinux_SambaPrinterOptionsProvider::removeDanglingShadowInstances (
  ...
  CmpiStatus CmpiLinux_SambaPrinterOptionsProvider::enumInstanceNames (
  ...
  CmpiStatus CmpiLinux_SambaPrinterOptionsProvider::enumInstances (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, const char* *properties){
    ...
    while ( enumeration.hasNext() ){
   	  ...
   	  const Linux_SambaPrinterOptionsManualInstance& instance=
       enumeration.getNext();
  ...
  CmpiStatus CmpiLinux_SambaPrinterOptionsProvider::getInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, const char* *properties){
     	
    //covert to instanceName
    Linux_SambaPrinterOptionsInstanceName instanceName(cop);
  ...
  CmpiStatus CmpiLinux_SambaPrinterOptionsProvider::createInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
...
//      Linux_SambaPrinterOptionsRepositoryInstance(inst,shadowNameSpaceP)
//      .getCmpiInstance(0);     
...
//       delete(backupShadowInstance);
  ...
  CmpiStatus CmpiLinux_SambaPrinterOptionsProvider::setInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, const CmpiInstance& inst,
...
//       delete(backupShadowInstance);
  ...
  CmpiStatus CmpiLinux_SambaPrinterOptionsProvider::deleteInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop){
      
    Linux_SambaPrinterOptionsInstanceName instanceName=
     Linux_SambaPrinterOptionsInstanceName(cop);
  ...
  CmpiStatus CmpiLinux_SambaPrinterOptionsProvider::invokeMethod (
   const CmpiContext& ctx, CmpiResult& rslt,
   ...
   const CmpiArgs& in, CmpiArgs& out){
    ...
    if (strcasecmp(methodName,"getAllSystemDefinedPrinters")==0){
        cout<<"executing method getAllSystemDefinedPrinters"<<endl;
                
        rslt.returnData(CmpiData(interfaceP->getAllSystemDefinedPrinters(
         ctx,
         cppBroker,
         instanceName)));
        cout<<"end of method getAllSystemDefinedPrinters"<<endl;     
      }else {
     rslt.returnDone();
