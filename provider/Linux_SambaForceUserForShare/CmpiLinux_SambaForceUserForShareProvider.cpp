...
namespace genProvider {
  ...
  CmpiLinux_SambaForceUserForShareProvider::
   ...
   const CmpiBroker &mbp, const CmpiContext& ctx):
    ...
    CmpiMethodMI(mbp,ctx), CmpiAssociationMI(mbp,ctx), cppBroker(mbp) {
      ...
      interfaceP=Linux_SambaForceUserForShareFactory::getImplementation();           
      cout<<"Provider was constructed"<<endl;
  };
    
        
  const char * CmpiLinux_SambaForceUserForShareProvider::
  ...
  int CmpiLinux_SambaForceUserForShareProvider::isUnloadable() const{
    return 0;
  }
  ...
  void CmpiLinux_SambaForceUserForShareProvider::completeInstance(
   const Linux_SambaForceUserForShareInstanceName& instanceName,
   CmpiInstance& target, const CmpiContext& ctx){
	  	
    Linux_SambaForceUserForShareInstanceName shadowInstanceName(instanceName);
  ...
  void CmpiLinux_SambaForceUserForShareProvider::copyShadowData (
  ...
  CmpiInstance* CmpiLinux_SambaForceUserForShareProvider::
  ...
  void CmpiLinux_SambaForceUserForShareProvider::removeDanglingShadowInstances (
   const Linux_SambaForceUserForShareInstanceNameEnumeration& dinInsNames){
  ...
  CMMethodMIFactory(
   CmpiLinux_SambaForceUserForShareProvider, CmpiLinux_SambaForceUserForShareProvider);
    ...
    CMAssociationMIFactory( CmpiLinux_SambaForceUserForShareProvider,
     CmpiLinux_SambaForceUserForShareProvider);
  ...
  CmpiStatus CmpiLinux_SambaForceUserForShareProvider::enumInstanceNames (
  ...
  CmpiStatus CmpiLinux_SambaForceUserForShareProvider::enumInstances (
   const CmpiContext& ctx, CmpiResult& rslt,
  ...
  CmpiStatus CmpiLinux_SambaForceUserForShareProvider::getInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, const char* *properties){
     	
    //covert to instanceName
    Linux_SambaForceUserForShareInstanceName instanceName(cop);
  ...
  CmpiStatus CmpiLinux_SambaForceUserForShareProvider::createInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
...
//      Linux_SambaForceUserForShareRepositoryInstance(inst,shadowNameSpaceP)
//      .getCmpiInstance(0);     
...
//       delete(backupShadowInstance);
  ...
  CmpiStatus CmpiLinux_SambaForceUserForShareProvider::setInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, const CmpiInstance& inst,
  ...
  CmpiStatus CmpiLinux_SambaForceUserForShareProvider::deleteInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop){
      
    Linux_SambaForceUserForShareInstanceName instanceName=
     Linux_SambaForceUserForShareInstanceName(cop);
  ...
  CmpiStatus CmpiLinux_SambaForceUserForShareProvider::invokeMethod (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& ref, const char* methodName,
   const CmpiArgs& in, CmpiArgs& out){
     	
    Linux_SambaForceUserForShareInstanceName instanceName=
     Linux_SambaForceUserForShareInstanceName(ref);
  ...
  CmpiStatus CmpiLinux_SambaForceUserForShareProvider::associationLogic( 
   ...
   const char** properties) {
    ...
    if( references == 0 && instances == 1 ) {
      ...
      while(enumeration.hasNext()) {
        ...
        const Linux_SambaForceUserForShareManualInstance manualInstance =
         enumeration.getNext();
  ...
  CmpiStatus CmpiLinux_SambaForceUserForShareProvider::associators (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, 
   ...
   const char** properties) {
    ...
    cout<<"calling associators() of class Linux_SambaForceUserForShare"<<endl;
  ...
  CmpiStatus CmpiLinux_SambaForceUserForShareProvider::associatorNames (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop,
   const char * assocClass, const char * resultClass,
   const char * role, const char * resultRole) {
   
    cout<<"calling associatorNames() of class Linux_SambaForceUserForShare"<<endl;
  ...
  CmpiStatus CmpiLinux_SambaForceUserForShareProvider::references ( 
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop,
   const char * assocClass, const char * role,
   const char** properties) {
    
    cout<<"calling references() of class Linux_SambaForceUserForShare"<<endl;
  ...
  CmpiStatus CmpiLinux_SambaForceUserForShareProvider::referenceNames (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop,
   const char * assocClass, const char * role) {
   
    cout<<"calling referenceNames() of class Linux_SambaForceUserForShare"<<endl;
