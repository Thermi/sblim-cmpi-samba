...
namespace genProvider {
  ...
  CmpiLinux_SambaGlobalOptionsProvider::
   ...
   const CmpiBroker &mbp, const CmpiContext& ctx):
    ...
    CmpiMethodMI(mbp,ctx), cppBroker(mbp) {
      ...
      interfaceP=Linux_SambaGlobalOptionsFactory::getImplementation();           
      cout<<"Provider was constructed"<<endl;
  };
    
        
  const char * CmpiLinux_SambaGlobalOptionsProvider::
  ...
  int CmpiLinux_SambaGlobalOptionsProvider::isUnloadable() const{
    return 0;
  }
  ...
  void CmpiLinux_SambaGlobalOptionsProvider::completeInstance(
   const Linux_SambaGlobalOptionsInstanceName& instanceName,
   CmpiInstance& target, const CmpiContext& ctx){
	  	
    Linux_SambaGlobalOptionsInstanceName shadowInstanceName(instanceName);
  ...
  void CmpiLinux_SambaGlobalOptionsProvider::copyShadowData (
  ...
  CmpiInstance* CmpiLinux_SambaGlobalOptionsProvider::
  ...
  void CmpiLinux_SambaGlobalOptionsProvider::removeDanglingShadowInstances (
  ...
  CmpiStatus CmpiLinux_SambaGlobalOptionsProvider::enumInstanceNames (
  ...
  CmpiStatus CmpiLinux_SambaGlobalOptionsProvider::enumInstances (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, const char* *properties){
    ...
    while ( enumeration.hasNext() ){
   	  ...
   	  const Linux_SambaGlobalOptionsManualInstance& instance=
       enumeration.getNext();
  ...
  CmpiStatus CmpiLinux_SambaGlobalOptionsProvider::getInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, const char* *properties){
     	
    //covert to instanceName
    Linux_SambaGlobalOptionsInstanceName instanceName(cop);
  ...
  CmpiStatus CmpiLinux_SambaGlobalOptionsProvider::createInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
...
//      Linux_SambaGlobalOptionsRepositoryInstance(inst,shadowNameSpaceP)
//      .getCmpiInstance(0);     
...
//       delete(backupShadowInstance);
  ...
  CmpiStatus CmpiLinux_SambaGlobalOptionsProvider::setInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, const CmpiInstance& inst,
...
//       delete(backupShadowInstance);
  ...
  CmpiStatus CmpiLinux_SambaGlobalOptionsProvider::deleteInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop){
      
    Linux_SambaGlobalOptionsInstanceName instanceName=
     Linux_SambaGlobalOptionsInstanceName(cop);
  ...
  CmpiStatus CmpiLinux_SambaGlobalOptionsProvider::invokeMethod (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& ref, const char* methodName,
   const CmpiArgs& in, CmpiArgs& out){
     	
    Linux_SambaGlobalOptionsInstanceName instanceName=
     Linux_SambaGlobalOptionsInstanceName(ref);
