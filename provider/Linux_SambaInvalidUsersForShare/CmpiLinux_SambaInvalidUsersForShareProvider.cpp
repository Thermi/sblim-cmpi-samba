...
namespace genProvider {
  ...
  CmpiLinux_SambaInvalidUsersForShareProvider::
   ...
   const CmpiBroker &mbp, const CmpiContext& ctx):
    ...
    CmpiMethodMI(mbp,ctx), CmpiAssociationMI(mbp,ctx), cppBroker(mbp) {
      ...
      interfaceP=Linux_SambaInvalidUsersForShareFactory::getImplementation();           
      cout<<"Provider was constructed"<<endl;
  };
    
        
  const char * CmpiLinux_SambaInvalidUsersForShareProvider::
  ...
  int CmpiLinux_SambaInvalidUsersForShareProvider::isUnloadable() const{
    return 0;
  }
  ...
  void CmpiLinux_SambaInvalidUsersForShareProvider::completeInstance(
   const Linux_SambaInvalidUsersForShareInstanceName& instanceName,
   CmpiInstance& target, const CmpiContext& ctx){
	  	
    Linux_SambaInvalidUsersForShareInstanceName shadowInstanceName(instanceName);
  ...
  void CmpiLinux_SambaInvalidUsersForShareProvider::copyShadowData (
  ...
  CmpiInstance* CmpiLinux_SambaInvalidUsersForShareProvider::
  ...
  void CmpiLinux_SambaInvalidUsersForShareProvider::removeDanglingShadowInstances (
   const Linux_SambaInvalidUsersForShareInstanceNameEnumeration& dinInsNames){
  ...
  CMMethodMIFactory(
   CmpiLinux_SambaInvalidUsersForShareProvider, CmpiLinux_SambaInvalidUsersForShareProvider);
    ...
    CMAssociationMIFactory( CmpiLinux_SambaInvalidUsersForShareProvider,
     CmpiLinux_SambaInvalidUsersForShareProvider);
  ...
  CmpiStatus CmpiLinux_SambaInvalidUsersForShareProvider::enumInstanceNames (
  ...
  CmpiStatus CmpiLinux_SambaInvalidUsersForShareProvider::enumInstances (
   const CmpiContext& ctx, CmpiResult& rslt,
  ...
  CmpiStatus CmpiLinux_SambaInvalidUsersForShareProvider::getInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, const char* *properties){
     	
    //covert to instanceName
    Linux_SambaInvalidUsersForShareInstanceName instanceName(cop);
  ...
  CmpiStatus CmpiLinux_SambaInvalidUsersForShareProvider::createInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
...
//      Linux_SambaInvalidUsersForShareRepositoryInstance(inst,shadowNameSpaceP)
//      .getCmpiInstance(0);     
...
//       delete(backupShadowInstance);
  ...
  CmpiStatus CmpiLinux_SambaInvalidUsersForShareProvider::setInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, const CmpiInstance& inst,
  ...
  CmpiStatus CmpiLinux_SambaInvalidUsersForShareProvider::deleteInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop){
      
    Linux_SambaInvalidUsersForShareInstanceName instanceName=
     Linux_SambaInvalidUsersForShareInstanceName(cop);
  ...
  CmpiStatus CmpiLinux_SambaInvalidUsersForShareProvider::invokeMethod (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& ref, const char* methodName,
   const CmpiArgs& in, CmpiArgs& out){
     	
    Linux_SambaInvalidUsersForShareInstanceName instanceName=
     Linux_SambaInvalidUsersForShareInstanceName(ref);
  ...
  CmpiStatus CmpiLinux_SambaInvalidUsersForShareProvider::associationLogic( 
   ...
   const char** properties) {
    ...
    if( references == 0 && instances == 1 ) {
      ...
      while(enumeration.hasNext()) {
        ...
        const Linux_SambaInvalidUsersForShareManualInstance manualInstance =
         enumeration.getNext();
  ...
  CmpiStatus CmpiLinux_SambaInvalidUsersForShareProvider::associators (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, 
   ...
   const char** properties) {
    ...
    cout<<"calling associators() of class Linux_SambaInvalidUsersForShare"<<endl;
  ...
  CmpiStatus CmpiLinux_SambaInvalidUsersForShareProvider::associatorNames (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop,
   const char * assocClass, const char * resultClass,
   const char * role, const char * resultRole) {
   
    cout<<"calling associatorNames() of class Linux_SambaInvalidUsersForShare"<<endl;
  ...
  CmpiStatus CmpiLinux_SambaInvalidUsersForShareProvider::references ( 
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop,
   const char * assocClass, const char * role,
   const char** properties) {
    
    cout<<"calling references() of class Linux_SambaInvalidUsersForShare"<<endl;
  ...
  CmpiStatus CmpiLinux_SambaInvalidUsersForShareProvider::referenceNames (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop,
   const char * assocClass, const char * role) {
   
    cout<<"calling referenceNames() of class Linux_SambaInvalidUsersForShare"<<endl;
