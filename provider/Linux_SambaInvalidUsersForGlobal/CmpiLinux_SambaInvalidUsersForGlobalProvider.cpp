...
namespace genProvider {
  ...
  CmpiLinux_SambaInvalidUsersForGlobalProvider::
   ...
   const CmpiBroker &mbp, const CmpiContext& ctx):
    ...
    CmpiMethodMI(mbp,ctx), CmpiAssociationMI(mbp,ctx), cppBroker(mbp) {
      ...
      interfaceP=Linux_SambaInvalidUsersForGlobalFactory::getImplementation();           
      cout<<"Provider was constructed"<<endl;
  };
    
        
  const char * CmpiLinux_SambaInvalidUsersForGlobalProvider::
  ...
  int CmpiLinux_SambaInvalidUsersForGlobalProvider::isUnloadable() const{
    return 0;
  }
  ...
  void CmpiLinux_SambaInvalidUsersForGlobalProvider::completeInstance(
   const Linux_SambaInvalidUsersForGlobalInstanceName& instanceName,
   CmpiInstance& target, const CmpiContext& ctx){
	  	
    Linux_SambaInvalidUsersForGlobalInstanceName shadowInstanceName(instanceName);
  ...
  void CmpiLinux_SambaInvalidUsersForGlobalProvider::copyShadowData (
  ...
  CmpiInstance* CmpiLinux_SambaInvalidUsersForGlobalProvider::
  ...
  void CmpiLinux_SambaInvalidUsersForGlobalProvider::removeDanglingShadowInstances (
  ...
  CMMethodMIFactory(
   CmpiLinux_SambaInvalidUsersForGlobalProvider, CmpiLinux_SambaInvalidUsersForGlobalProvider);
    ...
    CMAssociationMIFactory( CmpiLinux_SambaInvalidUsersForGlobalProvider,
     CmpiLinux_SambaInvalidUsersForGlobalProvider);
  ...
  CmpiStatus CmpiLinux_SambaInvalidUsersForGlobalProvider::enumInstanceNames (
  ...
  CmpiStatus CmpiLinux_SambaInvalidUsersForGlobalProvider::enumInstances (
   const CmpiContext& ctx, CmpiResult& rslt,
  ...
  CmpiStatus CmpiLinux_SambaInvalidUsersForGlobalProvider::getInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, const char* *properties){
     	
    //covert to instanceName
    Linux_SambaInvalidUsersForGlobalInstanceName instanceName(cop);
  ...
  CmpiStatus CmpiLinux_SambaInvalidUsersForGlobalProvider::createInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
...
//      Linux_SambaInvalidUsersForGlobalRepositoryInstance(inst,shadowNameSpaceP)
//      .getCmpiInstance(0);     
...
//       delete(backupShadowInstance);
  ...
  CmpiStatus CmpiLinux_SambaInvalidUsersForGlobalProvider::setInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, const CmpiInstance& inst,
  ...
  CmpiStatus CmpiLinux_SambaInvalidUsersForGlobalProvider::deleteInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop){
      
    Linux_SambaInvalidUsersForGlobalInstanceName instanceName=
     Linux_SambaInvalidUsersForGlobalInstanceName(cop);
  ...
  CmpiStatus CmpiLinux_SambaInvalidUsersForGlobalProvider::invokeMethod (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& ref, const char* methodName,
   const CmpiArgs& in, CmpiArgs& out){
     	
    Linux_SambaInvalidUsersForGlobalInstanceName instanceName=
     Linux_SambaInvalidUsersForGlobalInstanceName(ref);
  ...
  CmpiStatus CmpiLinux_SambaInvalidUsersForGlobalProvider::associationLogic( 
   ...
   const char** properties) {
    ...
    if( references == 0 && instances == 1 ) {
      ...
      while(enumeration.hasNext()) {
        ...
        const Linux_SambaInvalidUsersForGlobalManualInstance manualInstance =
         enumeration.getNext();
  ...
  CmpiStatus CmpiLinux_SambaInvalidUsersForGlobalProvider::associators (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, 
   ...
   const char** properties) {
    ...
    cout<<"calling associators() of class Linux_SambaInvalidUsersForGlobal"<<endl;
  ...
  CmpiStatus CmpiLinux_SambaInvalidUsersForGlobalProvider::associatorNames (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop,
   const char * assocClass, const char * resultClass,
   const char * role, const char * resultRole) {
   
    cout<<"calling associatorNames() of class Linux_SambaInvalidUsersForGlobal"<<endl;
  ...
  CmpiStatus CmpiLinux_SambaInvalidUsersForGlobalProvider::references ( 
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop,
   const char * assocClass, const char * role,
   const char** properties) {
    
    cout<<"calling references() of class Linux_SambaInvalidUsersForGlobal"<<endl;
  ...
  CmpiStatus CmpiLinux_SambaInvalidUsersForGlobalProvider::referenceNames (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop,
   const char * assocClass, const char * role) {
   
    cout<<"calling referenceNames() of class Linux_SambaInvalidUsersForGlobal"<<endl;
