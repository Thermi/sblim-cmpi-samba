...
namespace genProvider {
  ...
  CmpiLinux_SambaForceUserForPrinterProvider::
   ...
   const CmpiBroker &mbp, const CmpiContext& ctx):
    ...
    CmpiMethodMI(mbp,ctx), CmpiAssociationMI(mbp,ctx), cppBroker(mbp) {
      ...
      interfaceP=Linux_SambaForceUserForPrinterFactory::getImplementation();           
      cout<<"Provider was constructed"<<endl;
  };
    
        
  const char * CmpiLinux_SambaForceUserForPrinterProvider::
  ...
  int CmpiLinux_SambaForceUserForPrinterProvider::isUnloadable() const{
    return 0;
  }
  ...
  void CmpiLinux_SambaForceUserForPrinterProvider::completeInstance(
   const Linux_SambaForceUserForPrinterInstanceName& instanceName,
   CmpiInstance& target, const CmpiContext& ctx){
	  	
    Linux_SambaForceUserForPrinterInstanceName shadowInstanceName(instanceName);
  ...
  void CmpiLinux_SambaForceUserForPrinterProvider::copyShadowData (
  ...
  CmpiInstance* CmpiLinux_SambaForceUserForPrinterProvider::
  ...
  void CmpiLinux_SambaForceUserForPrinterProvider::removeDanglingShadowInstances (
  ...
  CMMethodMIFactory(
   CmpiLinux_SambaForceUserForPrinterProvider, CmpiLinux_SambaForceUserForPrinterProvider);
    ...
    CMAssociationMIFactory( CmpiLinux_SambaForceUserForPrinterProvider,
     CmpiLinux_SambaForceUserForPrinterProvider);
  ...
  CmpiStatus CmpiLinux_SambaForceUserForPrinterProvider::enumInstanceNames (
  ...
  CmpiStatus CmpiLinux_SambaForceUserForPrinterProvider::enumInstances (
   const CmpiContext& ctx, CmpiResult& rslt,
  ...
  CmpiStatus CmpiLinux_SambaForceUserForPrinterProvider::getInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, const char* *properties){
     	
    //covert to instanceName
    Linux_SambaForceUserForPrinterInstanceName instanceName(cop);
  ...
  CmpiStatus CmpiLinux_SambaForceUserForPrinterProvider::createInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
...
//      Linux_SambaForceUserForPrinterRepositoryInstance(inst,shadowNameSpaceP)
//      .getCmpiInstance(0);     
...
//       delete(backupShadowInstance);
  ...
  CmpiStatus CmpiLinux_SambaForceUserForPrinterProvider::setInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, const CmpiInstance& inst,
  ...
  CmpiStatus CmpiLinux_SambaForceUserForPrinterProvider::deleteInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop){
      
    Linux_SambaForceUserForPrinterInstanceName instanceName=
     Linux_SambaForceUserForPrinterInstanceName(cop);
  ...
  CmpiStatus CmpiLinux_SambaForceUserForPrinterProvider::invokeMethod (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& ref, const char* methodName,
   const CmpiArgs& in, CmpiArgs& out){
     	
    Linux_SambaForceUserForPrinterInstanceName instanceName=
     Linux_SambaForceUserForPrinterInstanceName(ref);
  ...
  CmpiStatus CmpiLinux_SambaForceUserForPrinterProvider::associationLogic( 
   ...
   const char** properties) {
    ...
    if( references == 0 && instances == 1 ) {
      ...
      while(enumeration.hasNext()) {
        ...
        const Linux_SambaForceUserForPrinterManualInstance manualInstance =
         enumeration.getNext();
  ...
  CmpiStatus CmpiLinux_SambaForceUserForPrinterProvider::associators (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, 
   ...
   const char** properties) {
    ...
    cout<<"calling associators() of class Linux_SambaForceUserForPrinter"<<endl;
  ...
  CmpiStatus CmpiLinux_SambaForceUserForPrinterProvider::associatorNames (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop,
   const char * assocClass, const char * resultClass,
   const char * role, const char * resultRole) {
   
    cout<<"calling associatorNames() of class Linux_SambaForceUserForPrinter"<<endl;
  ...
  CmpiStatus CmpiLinux_SambaForceUserForPrinterProvider::references ( 
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop,
   const char * assocClass, const char * role,
   const char** properties) {
    
    cout<<"calling references() of class Linux_SambaForceUserForPrinter"<<endl;
  ...
  CmpiStatus CmpiLinux_SambaForceUserForPrinterProvider::referenceNames (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop,
   const char * assocClass, const char * role) {
   
    cout<<"calling referenceNames() of class Linux_SambaForceUserForPrinter"<<endl;
