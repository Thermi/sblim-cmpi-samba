...
namespace genProvider {
  ...
  CmpiLinux_SambaAdminUsersForShareProvider::
   ...
   const CmpiBroker &mbp, const CmpiContext& ctx):
    ...
    CmpiMethodMI(mbp,ctx), CmpiAssociationMI(mbp,ctx), cppBroker(mbp) {
      ...
      interfaceP=Linux_SambaAdminUsersForShareFactory::getImplementation();           
      cout<<"Provider was constructed"<<endl;
  };
    
        
  const char * CmpiLinux_SambaAdminUsersForShareProvider::
  ...
  int CmpiLinux_SambaAdminUsersForShareProvider::isUnloadable() const{
    return 0;
  }
  ...
  void CmpiLinux_SambaAdminUsersForShareProvider::completeInstance(
   const Linux_SambaAdminUsersForShareInstanceName& instanceName,
   CmpiInstance& target, const CmpiContext& ctx){
	  	
    Linux_SambaAdminUsersForShareInstanceName shadowInstanceName(instanceName);
  ...
  void CmpiLinux_SambaAdminUsersForShareProvider::copyShadowData (
  ...
  CmpiInstance* CmpiLinux_SambaAdminUsersForShareProvider::
  ...
  void CmpiLinux_SambaAdminUsersForShareProvider::removeDanglingShadowInstances (
  ...
  CMMethodMIFactory(
   CmpiLinux_SambaAdminUsersForShareProvider, CmpiLinux_SambaAdminUsersForShareProvider);
    ...
    CMAssociationMIFactory( CmpiLinux_SambaAdminUsersForShareProvider,
     CmpiLinux_SambaAdminUsersForShareProvider);
  ...
  CmpiStatus CmpiLinux_SambaAdminUsersForShareProvider::enumInstanceNames (
  ...
  CmpiStatus CmpiLinux_SambaAdminUsersForShareProvider::enumInstances (
   const CmpiContext& ctx, CmpiResult& rslt,
  ...
  CmpiStatus CmpiLinux_SambaAdminUsersForShareProvider::getInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, const char* *properties){
     	
    //covert to instanceName
    Linux_SambaAdminUsersForShareInstanceName instanceName(cop);
  ...
  CmpiStatus CmpiLinux_SambaAdminUsersForShareProvider::createInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
...
//      Linux_SambaAdminUsersForShareRepositoryInstance(inst,shadowNameSpaceP)
//      .getCmpiInstance(0);     
...
//       delete(backupShadowInstance);
  ...
  CmpiStatus CmpiLinux_SambaAdminUsersForShareProvider::setInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, const CmpiInstance& inst,
  ...
  CmpiStatus CmpiLinux_SambaAdminUsersForShareProvider::deleteInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop){
      
    Linux_SambaAdminUsersForShareInstanceName instanceName=
     Linux_SambaAdminUsersForShareInstanceName(cop);
  ...
  CmpiStatus CmpiLinux_SambaAdminUsersForShareProvider::invokeMethod (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& ref, const char* methodName,
   const CmpiArgs& in, CmpiArgs& out){
     	
    Linux_SambaAdminUsersForShareInstanceName instanceName=
     Linux_SambaAdminUsersForShareInstanceName(ref);
  ...
  CmpiStatus CmpiLinux_SambaAdminUsersForShareProvider::associationLogic( 
   ...
   const char** properties) {
    ...
    if( references == 0 && instances == 1 ) {
      ...
      while(enumeration.hasNext()) {
        ...
        const Linux_SambaAdminUsersForShareManualInstance manualInstance =
         enumeration.getNext();
  ...
  CmpiStatus CmpiLinux_SambaAdminUsersForShareProvider::associators (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, 
   ...
   const char** properties) {
    ...
    cout<<"calling associators() of class Linux_SambaAdminUsersForShare"<<endl;
  ...
  CmpiStatus CmpiLinux_SambaAdminUsersForShareProvider::associatorNames (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop,
   const char * assocClass, const char * resultClass,
   const char * role, const char * resultRole) {
   
    cout<<"calling associatorNames() of class Linux_SambaAdminUsersForShare"<<endl;
  ...
  CmpiStatus CmpiLinux_SambaAdminUsersForShareProvider::references ( 
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop,
   const char * assocClass, const char * role,
   const char** properties) {
    
    cout<<"calling references() of class Linux_SambaAdminUsersForShare"<<endl;
  ...
  CmpiStatus CmpiLinux_SambaAdminUsersForShareProvider::referenceNames (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop,
   const char * assocClass, const char * role) {
   
    cout<<"calling referenceNames() of class Linux_SambaAdminUsersForShare"<<endl;
