...
namespace genProvider {
  ...
  private:
       void init();
       void init(const Linux_SambaAdminUsersForShareInstanceName& original);
       void reset();
  ...
  class Linux_SambaAdminUsersForShareInstanceNameEnumeration {
  	private:
  	  Linux_SambaAdminUsersForShareInstanceNameEnumerationElement* firstElementP;
  	  Linux_SambaAdminUsersForShareInstanceNameEnumerationElement* currentElementP;
  	  Linux_SambaAdminUsersForShareInstanceNameEnumerationElement* endElementP;
  	...
  	public:
  	  ...
  	  const Linux_SambaAdminUsersForShareInstanceName& getElement(int pos) const;  	  
  	  
  	  //no copy of the element is done
  	  void addElement(const Linux_SambaAdminUsersForShareInstanceName& elementP);
