...
int main (int argc, char *argv[]) {
  ...
  printf("Deleting Samba group %s. Result was: %d\n",smbgrp,
	                          delete_samba_group(smbgrp));

  printf("Deleting Samba group %s. Result was: %d\n",smbgrp2,
	                          delete_samba_group(smbgrp2));

  printf("Deleting Samba group %s. Result was: %d\n",smbgrp3,
	                          delete_samba_group(smbgrp3));
